...
The first release worth a number. kolu is a terminal workspace built for scale — real `xterm.js` tiles on an infinite canvas, agent-agnostic, auto-detected, zero setup. Track `master` for the latest; pin this build with `nix run github:juspay/kolu/v1.0`.
