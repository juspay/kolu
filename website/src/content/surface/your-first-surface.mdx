...
That one declaration is the contract. From it the framework derives the server
router and the client hooks — you never hand-write either. (For *why* there are
...
what keeps a reconnect honest (see [Reactive honesty](/surface/reactive-honesty)).
