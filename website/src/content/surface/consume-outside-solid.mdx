...
description: "Read a surface from a CLI or TUI with a transport-blind connection — composed calls, iterated streams, and a live board via mirrorRemoteSurface."
order: 221
