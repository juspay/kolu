...
hosts once at admit; `probeSurfaceClockNow(client)` performs the round-trip and
`clockOffsetFrom(remoteEpochMs, localEpochMs)` computes `remoteEpochMs − localEpochMs`.
