...
`set-cookie` — node's one array-shaped exception, and the one header whose values
carry commas of their own — is **refused at the allowlist** rather than folded
into a string nothing could split back apart (RFC 6265 §5.2).
