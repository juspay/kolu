...
provisioning window. A raw re-throw would cross oRPC sanitized to a non-retriable
error and strand the downstream — this named end is what makes fail-through
actually recover. Holding open a byte stream is a compile error.
