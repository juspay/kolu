...
- **`drain-newer-else-refuse`** (padi): a newer build is drained in and replaces the old; anything else is refused. This arm is only available to a drain-capable handshake.
