...
| `probeDaemonIdentityFrom({ client, dispose, capability, awaitExit?, drainCeilingMs? })` | single probe-assembly authority for an already-dialed connector; SSH keeps its stronger process-exit oracle instead of treating link loss as exit |
