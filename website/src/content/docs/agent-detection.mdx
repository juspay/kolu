...
description: "How kolu reads the live state of Claude Code, Codex, Grok, OpenCode, Pi, and Xyne from each terminal — the shared state vocabulary shown on the dock and tile, and what each agent can and can't report."
order: 80
section: Agents
koluHero:
  eyebrow: awareness
...
[Xyne](https://github.com/xynehq/xyne-cli) — it reads that agent's own
