...
<Aside type="note" title="HTTP can still be pinned">
  ...
  [From another device](/remote-access) for the private HTTPS route.
</Aside>
...
<CardGrid>
  <LinkCard title="From another device" href="/remote-access" description="serve kolu at a private https://...ts.net URL" />
