...
| `packages/runtime-diagnostics/`      | Process-local registry for active watchers, timers, subscriptions, and DB handles surfaced by `server.diagnostics`                                                    |
