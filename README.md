...
- Create, switch, close, and drag-to-reorder workspaces from a collapsible sidebar
- Terminal panel — `Ctrl+`` splits a bottom panel per workspace; `Ctrl+Shift+``adds tabs,`Ctrl+PageDown/Up` cycles
