...
- **Canvas navigation** — the command palette can center the active tile when panning has moved it out of view or arrange the canvas by repo into side-by-side square-ish clusters that preserve each tile's current size
