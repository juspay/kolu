...
- The taxonomy (what lives in `docs/` vs GitHub Issues vs the blog) and the rationale live in the Atlas design — `docs/atlas/src/content/atlas/second-brain.mdx` (rendered to `docs/atlas/dist/second-brain.html`).
