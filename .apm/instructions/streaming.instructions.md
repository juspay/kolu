---
description: Cross-file invariants for oRPC streaming procedures (STREAM_RETRY via client.rawStream/unenrolledStreamCall, server snapshot-then-deltas, plugin context parameterization)
