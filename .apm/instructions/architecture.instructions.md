---
description: Architecture documentation requirements — keep the kolu.dev Architecture doc in sync with structural changes
applyTo: "{README.md,website/src/content/docs/architecture.mdx}"
---
