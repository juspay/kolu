Feature: Mission Control
  ...
  Scenario: Quick Ctrl+Tab release switches to previous terminal
    ...
    When I release Ctrl
    Then Mission Control should not be visible
    And the active workspace should show "quick-switch-target"
    And there should be no page errors
  ...
  Scenario: Keyboard input does not leak to terminal
    ...
    And I press Escape
    Then Mission Control should not be visible
    And the active workspace should not show "leaked-text"
    And there should be no page errors
  ...
  Scenario: Click card switches to correct terminal
    ...
    Then Mission Control should not be visible
    And the active workspace should show "mc-target"
    And there should be no page errors
