Feature: Keyboard Shortcuts
  ...
  Scenario: Switch workspace with Mod+1-9
    When I open the app
    ...
    Then the active workspace should show "shortcut-second"
    And there should be no page errors
  ...
  Scenario: Cycle terminals with next/prev shortcuts
    ...
    Then the active workspace should show "cycle-second"
    # Next should go back to terminal 3.
    When I press the next terminal shortcut
    Then the active workspace should show "cycle-third"
    And there should be no page errors
  ...
  Scenario: Create terminal with shortcut
    ...
    Then the sidebar should have 1 more workspace entry
