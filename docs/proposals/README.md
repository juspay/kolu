...
2. **Open a PR** that adds only your proposal file. Use the PR body to summarize and link any related issues. **If you're still brainstorming** — lots of open questions, unsure of direction, looking for early input — open it as a *draft* PR. That signals "give me directional feedback, not line-by-line review yet." Mark it ready for review once the open questions are narrowed.
