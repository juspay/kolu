...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">interface</span><span style=\"color:#6F42C1\"> Subscription</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#6F42C1\">T</span><span style=\"color:#24292E\">> </span><span style=\"color:#D73A49\">extends</span><span style=\"color:#6F42C1\"> Accessor</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#6F42C1\">T</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#005CC5\"> undefined</span><span style=\"color:#24292E\">> {</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">  // pending / error / complete as today, plus:</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  updated</span><span style=\"color:#24292E\">(</span><span style=\"color:#6F42C1\">handler</span><span style=\"color:#D73A49\">:</span><span style=\"color:#24292E\"> (</span><span style=\"color:#E36209\">change</span><span style=\"color:#D73A49\">:</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">prev</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> T</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">next</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> T</span><span style=\"color:#24292E\"> }) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#005CC5\"> void</span><span style=\"color:#24292E\">)</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Dispose</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">  // fires exactly when the value CHANGES (equals-deduped at the producer);</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">  // a first frame is a value, not a change — it never fires;</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">  // a reconnect snapshot equal to the last-seen value never fires;</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">  // one that differs fires exactly once, prev = the last-seen value.</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">}</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">function</span><span style=\"color:#6F42C1\"> watchByEntry</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#6F42C1\">A</span><span style=\"color:#24292E\">>(</span><span style=\"color:#E36209\">client</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">cell</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">items</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">onRaise</span><span style=\"color:#24292E\">)</span><span style=\"color:#D73A49\">:</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  get</span><span style=\"color:#24292E\">(</span><span style=\"color:#E36209\">key</span><span style=\"color:#24292E\">)</span><span style=\"color:#D73A49\">:</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">kind</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"live\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#032F62\"> \"stale\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">value</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> A</span><span style=\"color:#24292E\"> } </span><span style=\"color:#D73A49\">|</span><span style=\"color:#005CC5\"> undefined</span><span style=\"color:#24292E\">;  </span><span style=\"color:#6A737D\">// chips read this</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">};  </span><span style=\"color:#6A737D\">// deliberately NO total(): aggregation is app policy (the two consumers disagree)</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// @kolu/surface-app — delivery at the origin's ONE service worker (never per window):</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">notify.</span><span style=\"color:#6F42C1\">show</span><span style=\"color:#24292E\">({ tag: </span><span style=\"color:#032F62\">`${</span><span style=\"color:#24292E\">host</span><span style=\"color:#032F62\">}/${</span><span style=\"color:#24292E\">itemId</span><span style=\"color:#032F62\">}`</span><span style=\"color:#24292E\">, title, data: { host, itemId } });  </span><span style=\"color:#6A737D\">// same tag replaces, never stacks</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">notify.</span><span style=\"color:#6F42C1\">onClick</span><span style=\"color:#24292E\">(({ </span><span style=\"color:#E36209\">host</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">itemId</span><span style=\"color:#24292E\"> }) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> { </span><span style=\"color:#6A737D\">/* the app routes */</span><span style=\"color:#24292E\"> });</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
			"The ",
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// padi — no new member, no production change in W5: cells.urgency ships today</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// (packages/padi/src/surface.ts). Its re-production as a declaration —</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// derived.cell(($) => recomputeUrgency($.terminals())) — is bridge PHASE 1,</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// sequenced after W5; cell, equals (urgencyEqual), and consumers unchanged.</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// client — chips, badge, notification:</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> att</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#6F42C1\"> watchByEntry</span><span style=\"color:#24292E\">(padiMap, </span><span style=\"color:#E36209\">e</span><span style=\"color:#D73A49\"> =></span><span style=\"color:#24292E\"> e.cells.urgency, </span><span style=\"color:#E36209\">v</span><span style=\"color:#D73A49\"> =></span><span style=\"color:#24292E\"> v.awaitingIds,</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  (</span><span style=\"color:#E36209\">host</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">raised</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> raised.</span><span style=\"color:#6F42C1\">forEach</span><span style=\"color:#24292E\">(</span><span style=\"color:#E36209\">id</span><span style=\"color:#D73A49\"> =></span></span>\n<span class=\"line\"><span style=\"color:#24292E\">    notify.</span><span style=\"color:#6F42C1\">show</span><span style=\"color:#24292E\">({ tag: </span><span style=\"color:#032F62\">`${</span><span style=\"color:#24292E\">host</span><span style=\"color:#032F62\">}/${</span><span style=\"color:#24292E\">id</span><span style=\"color:#032F62\">}`</span><span style=\"color:#24292E\">, title: </span><span style=\"color:#032F62\">`terminal awaiting on ${</span><span style=\"color:#6F42C1\">hostLabel</span><span style=\"color:#032F62\">(</span><span style=\"color:#24292E\">host</span><span style=\"color:#032F62\">)</span><span style=\"color:#032F62\">}`</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">                  data: { host, id } })));</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// chip(host): att.get(host) — count = value.awaitingIds.length, dimmed when stale</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// badge: Σ awaitingIds.length over LIVE hosts — kolu's own one-line fold</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">notify.</span><span style=\"color:#6F42C1\">onClick</span><span style=\"color:#24292E\">(({ </span><span style=\"color:#E36209\">host</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">id</span><span style=\"color:#24292E\"> }) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> { </span><span style=\"color:#6F42C1\">switchHost</span><span style=\"color:#24292E\">(host); </span><span style=\"color:#6F42C1\">focusTerminal</span><span style=\"color:#24292E\">(id); });</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// server — the one writer, declared (bridge phase 0's first consumer):</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> metrics</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#6F42C1\"> source</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#6F42C1\">MetricsFrame</span><span style=\"color:#24292E\">>((</span><span style=\"color:#E36209\">emit</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#6F42C1\"> installMetricsTap</span><span style=\"color:#24292E\">(emit));</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">cells.alerts </span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\"> derived.</span><span style=\"color:#6F42C1\">cell</span><span style=\"color:#24292E\">(</span><span style=\"color:#6F42C1\">scan</span><span style=\"color:#24292E\">(metrics, noAlerts, applyHysteresis));</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// no store — the alert level must not survive restarts;</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// step returning the prev reference ⇒ no publish</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// a held level publishes nothing (alerts' spec equals), so updated()</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// fires only on a genuine raise/clear</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// client:</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> att</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#6F42C1\"> watchByEntry</span><span style=\"color:#24292E\">(hostMap, </span><span style=\"color:#E36209\">e</span><span style=\"color:#D73A49\"> =></span><span style=\"color:#24292E\"> e.cells.alerts, </span><span style=\"color:#E36209\">v</span><span style=\"color:#D73A49\"> =></span><span style=\"color:#24292E\"> v.items.</span><span style=\"color:#6F42C1\">map</span><span style=\"color:#24292E\">(</span><span style=\"color:#E36209\">i</span><span style=\"color:#D73A49\"> =></span><span style=\"color:#24292E\"> i.id),</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  (</span><span style=\"color:#E36209\">host</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">raised</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">v</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> raised.</span><span style=\"color:#6F42C1\">forEach</span><span style=\"color:#24292E\">(</span><span style=\"color:#E36209\">id</span><span style=\"color:#D73A49\"> =></span></span>\n<span class=\"line\"><span style=\"color:#24292E\">    notify.</span><span style=\"color:#6F42C1\">show</span><span style=\"color:#24292E\">({ tag: </span><span style=\"color:#032F62\">`${</span><span style=\"color:#24292E\">host</span><span style=\"color:#032F62\">}/${</span><span style=\"color:#24292E\">id</span><span style=\"color:#032F62\">}`</span><span style=\"color:#24292E\">, title: </span><span style=\"color:#6F42C1\">labelOf</span><span style=\"color:#24292E\">(v, id), data: { host, id } })));</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// badge: count of hosts with any live alert — drishti's own fold, NOT a sum</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">notify.</span><span style=\"color:#6F42C1\">onClick</span><span style=\"color:#24292E\">(({ </span><span style=\"color:#E36209\">host</span><span style=\"color:#24292E\"> }) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#6F42C1\"> expandHost</span><span style=\"color:#24292E\">(host));</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/surface-attention-101.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/surface-attention-101.mdx";
