...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.h3, {
			id: "skill-parity--the-bridge--kolu-migration-contract",
			children: "Skill parity — the /bridge · /kolu migration contract"
		}),
		"\n",
		createVNode(_components.p, { children: [
			"The end state (ratified): the ",
			createVNode(_components.strong, { children: [
				"/bridge and /kolu skills drive agents\nthrough this MCP when it’s available, falling back to ",
				createVNode(_components.code, { children: "kaval-tui" }),
				"/",
				createVNode(_components.code, { children: "padi-tui" }),
				"\nwhen it isn’t"
...
function getHeadings() {
	return [
		...
		{
			"depth": 3,
			"slug": "skill-parity--the-bridge--kolu-migration-contract",
			"text": "Skill parity — the /bridge · /kolu migration contract"
		},
		{
			"depth": 3,
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/kolu-cli.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/kolu-cli.mdx";
