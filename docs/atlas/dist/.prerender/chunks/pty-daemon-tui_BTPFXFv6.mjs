...
`
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"text\"><code><span class=\"line\"><span>$ kaval-tui list</span></span>\n<span class=\"line\"><span>kaval-tui: no pty-host socket at /run/user/1000/kolu/pty-host.sock (ECONNREFUSED)</span></span>\n<span class=\"line\"><span>          is kolu-server running? the socket appears once it boots.</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"bash\"><code><span class=\"line\"><span style=\"color:#6A737D\">#!/usr/bin/env bash</span></span>\n<span class=\"line\"><span style=\"color:#005CC5\">set</span><span style=\"color:#005CC5\"> -euo</span><span style=\"color:#032F62\"> pipefail</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\"># 1 · create a PTY with a unique marker in its scrollback (create never attaches)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">id</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">$(</span><span style=\"color:#6F42C1\">kaval-tui</span><span style=\"color:#032F62\"> create</span><span style=\"color:#005CC5\"> --json</span><span style=\"color:#005CC5\"> --</span><span style=\"color:#032F62\"> bash</span><span style=\"color:#005CC5\"> -c</span><span style=\"color:#032F62\"> 'echo \"MARK-$$\"; exec sleep 1d'</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#6F42C1\"> jq</span><span style=\"color:#005CC5\"> -r</span><span style=\"color:#032F62\"> .id</span><span style=\"color:#24292E\">)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">pid_before</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">$(</span><span style=\"color:#6F42C1\">kaval-tui</span><span style=\"color:#032F62\"> list</span><span style=\"color:#005CC5\"> --json</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#6F42C1\"> jq</span><span style=\"color:#005CC5\"> -r</span><span style=\"color:#032F62\"> \".[] | select(.id==</span><span style=\"color:#005CC5\">\\\"</span><span style=\"color:#24292E\">$id</span><span style=\"color:#005CC5\">\\\"</span><span style=\"color:#032F62\">).pid\"</span><span style=\"color:#24292E\">)</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\"># 2 · (no kaval-tui process is attached — simulating client death)</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\"># 3 · a fresh client re-attaches by id and asserts the state is intact</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">kaval-tui</span><span style=\"color:#032F62\"> snapshot</span><span style=\"color:#032F62\"> \"</span><span style=\"color:#24292E\">$id</span><span style=\"color:#032F62\">\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#6F42C1\"> grep</span><span style=\"color:#005CC5\"> -q</span><span style=\"color:#032F62\"> \"MARK-\"</span><span style=\"color:#6A737D\">            # scrollback preserved</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">pid_after</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">$(</span><span style=\"color:#6F42C1\">kaval-tui</span><span style=\"color:#032F62\"> list</span><span style=\"color:#005CC5\"> --json</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#6F42C1\"> jq</span><span style=\"color:#005CC5\"> -r</span><span style=\"color:#032F62\"> \".[] | select(.id==</span><span style=\"color:#005CC5\">\\\"</span><span style=\"color:#24292E\">$id</span><span style=\"color:#005CC5\">\\\"</span><span style=\"color:#032F62\">).pid\"</span><span style=\"color:#24292E\">)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">[ </span><span style=\"color:#032F62\">\"</span><span style=\"color:#24292E\">$pid_before</span><span style=\"color:#032F62\">\"</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#032F62\"> \"</span><span style=\"color:#24292E\">$pid_after</span><span style=\"color:#032F62\">\"</span><span style=\"color:#24292E\"> ]                     </span><span style=\"color:#6A737D\"># same PTY, not a respawn</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#005CC5\">echo</span><span style=\"color:#032F62\"> \"✓ client came and went; server held the PTY (pid </span><span style=\"color:#24292E\">$pid_after</span><span style=\"color:#032F62\"> unchanged)\"</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/pty-daemon-tui.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/pty-daemon-tui.mdx";
