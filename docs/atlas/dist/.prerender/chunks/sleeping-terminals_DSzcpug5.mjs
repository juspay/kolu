...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> ActiveTerminalSchema</span><span style=\"color:#D73A49\"> =</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  PersistedTerminalFieldsSchema.</span><span style=\"color:#6F42C1\">merge</span><span style=\"color:#24292E\">(LiveTerminalFieldsSchema)   </span><span style=\"color:#6A737D\">// live overlay present</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">    .</span><span style=\"color:#6F42C1\">extend</span><span style=\"color:#24292E\">({ state: z.</span><span style=\"color:#6F42C1\">literal</span><span style=\"color:#24292E\">(</span><span style=\"color:#032F62\">\"active\"</span><span style=\"color:#24292E\">) });</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> SleepingTerminalSchema</span><span style=\"color:#D73A49\"> =</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  PersistedTerminalFieldsSchema                                   </span><span style=\"color:#6A737D\">// base only — overlay absent by type</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">    .</span><span style=\"color:#6F42C1\">extend</span><span style=\"color:#24292E\">({ state: z.</span><span style=\"color:#6F42C1\">literal</span><span style=\"color:#24292E\">(</span><span style=\"color:#032F62\">\"sleeping\"</span><span style=\"color:#24292E\">), sleptAt: z.</span><span style=\"color:#6F42C1\">number</span><span style=\"color:#24292E\">() });</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> TerminalMetadataSchema</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#6A737D\">                                   // the wire / collection shape</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  z.</span><span style=\"color:#6F42C1\">discriminatedUnion</span><span style=\"color:#24292E\">(</span><span style=\"color:#032F62\">\"state\"</span><span style=\"color:#24292E\">, [ActiveTerminalSchema, SleepingTerminalSchema]);</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">type</span><span style=\"color:#6F42C1\"> Terminal</span><span style=\"color:#D73A49\"> =</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> ({ </span><span style=\"color:#E36209\">state</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"active\"</span><span style=\"color:#24292E\"> }                    </span><span style=\"color:#D73A49\">&#x26;</span><span style=\"color:#6F42C1\"> PersistedTerminalFields</span><span style=\"color:#D73A49\"> &#x26;</span><span style=\"color:#6F42C1\"> LiveTerminalFields</span><span style=\"color:#24292E\">)</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> ({ </span><span style=\"color:#E36209\">state</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"sleeping\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">sleptAt</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> number</span><span style=\"color:#24292E\"> } </span><span style=\"color:#D73A49\">&#x26;</span><span style=\"color:#6F42C1\"> PersistedTerminalFields</span><span style=\"color:#24292E\">);</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// Presence reads the union; touching a live field MUST narrow.</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#6F42C1\"> placeTile</span><span style=\"color:#D73A49\">  =</span><span style=\"color:#24292E\"> (</span><span style=\"color:#E36209\">t</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Terminal</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> t.canvasLayout;             </span><span style=\"color:#6A737D\">// both arms — no narrow</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#6F42C1\"> routeInput</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#24292E\"> (</span><span style=\"color:#E36209\">t</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Terminal</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  if</span><span style=\"color:#24292E\"> (t.state </span><span style=\"color:#D73A49\">!==</span><span style=\"color:#032F62\"> \"active\"</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">return</span><span style=\"color:#24292E\">;                             </span><span style=\"color:#6A737D\">// compiler-forced narrow</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  send</span><span style=\"color:#24292E\">(t </span><span style=\"color:#6A737D\">/* now carries pr · agent · foreground + a live PTY */</span><span style=\"color:#24292E\">);</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">};</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/sleeping-terminals.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/sleeping-terminals.mdx";
