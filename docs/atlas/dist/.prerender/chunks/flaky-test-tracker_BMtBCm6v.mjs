...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.p, { children: [
			...
			"’s darwin lane and cleared on a same-SHA rerun (change-independent — the PR touches no kaval restart path). Same rasam-load sensitivity class as its first sighting. Recurred AGAIN on ",
			createVNode($$PrLink, { pr: 1903 }),
			" (deep-link false-gone fix, client-only — zero kaval-restart/warming-canvas code; ",
			createVNode(_components.code, { children: "useDaemonStatus.ts" }),
			"’s only edit is an additive ",
			createVNode(_components.code, { children: "listIsAuthoritative()" }),
			" + docstring, and ",
			createVNode(_components.code, { children: "daemonWarming" }),
			"/",
			createVNode(_components.code, { children: "downState" }),
			"/",
			createVNode(_components.code, { children: "daemonStatusPending" }),
			" are untouched): first-red on ",
			createVNode(_components.code, { children: "e2e@aarch64-darwin" }),
			" (rasam) as the ",
			createVNode(_components.code, { children: "the warming canvas is shown while kaval restarts" }),
			" step, alongside the same nix ",
			createVNode(_components.code, { children: "SQLite '…/eval-cache-v5/….sqlite' is busy" }),
			" eval-cache-contention warning AND a concurrent e2e suite holding ",
			createVNode(_components.code, { children: "/tmp/kolu-e2e-suite.lock" }),
			" on the shared box — cleared on a same-SHA node rerun (521/521, 4620/4620 steps). | ",
			createVNode($$PrLink, { pr: 1795 }),
			", ",
			createVNode($$PrLink, { pr: 1808 }),
			", ",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/flaky-test-tracker.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/flaky-test-tracker.mdx";
