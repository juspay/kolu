...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.p, { children: [
			...
			". The deployed kolu binds the host’s default state-root; a dev kolu and each e2e worker pass their own private one, which also gives them a private kaval. A dev instance therefore ",
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// @kolu/surface-remote — ONE framework type; the connector declares its own phases</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">type</span><span style=\"color:#6F42C1\"> SessionState</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#6F42C1\">Prov</span><span style=\"color:#D73A49\"> extends</span><span style=\"color:#005CC5\"> string</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#005CC5\"> never</span><span style=\"color:#24292E\">> </span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#E36209\">  log</span><span style=\"color:#D73A49\">:</span><span style=\"color:#D73A49\"> readonly</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">source</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"local\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#032F62\"> \"remote\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">line</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> string</span><span style=\"color:#24292E\"> }[]; </span><span style=\"color:#6A737D\">// last 20; per-EPISODE (reset on a down→up crossing)</span></span>\n<span class=\"line\"><span style=\"color:#E36209\">  sinceMs</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> number</span><span style=\"color:#24292E\">; </span><span style=\"color:#6A737D\">// current episode's elapsed, stamped on the SERVER's clock — a duration, never a foreign epoch</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">} </span><span style=\"color:#D73A49\">&#x26;</span><span style=\"color:#24292E\"> (</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">phase</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"connecting\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#032F62\"> \"connected\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#6F42C1\"> Prov</span><span style=\"color:#24292E\"> }                  </span><span style=\"color:#6A737D\">// up — error fields don't exist</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">phase</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"disconnected\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">error</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> string</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">cause</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"network\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#032F62\"> \"remote\"</span><span style=\"color:#24292E\"> }</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">phase</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"failed\"</span><span style=\"color:#24292E\">;       </span><span style=\"color:#E36209\">error</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> string</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">cause</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"remote\"</span><span style=\"color:#24292E\"> }     </span><span style=\"color:#6A737D\">// network is never terminal — by type</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">);</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">type</span><span style=\"color:#6F42C1\"> SshProv</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#032F62\"> \"probing\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#032F62\"> \"copying\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#032F62\"> \"building\"</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">//  probing  = the warm realise-probe (is padi already there?) — presented calmly, no build UI</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">//  copying  = nix copy --derivation …  (the .drv push — fast)</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">//  building = ssh $host nix-store --realise …  (the remote compile — the minutes)</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// sshConnector: SessionState&#x3C;SshProv> · local endpoint: SessionState&#x3C;never></span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// browser cell: ConnectionInfo = SessionState&#x3C;SshProv>, LITERALLY — the zod schema's</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// inferred type is pinned identical by a test-d file, so schema/type drift is a compile error.</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// ConnectPhase = Exclude&#x3C;ConnectionInfo[\"phase\"], \"connected\"|\"disconnected\"|\"failed\"></span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// — the one narratable-phase vocabulary, exported beside its owner; consumers</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// derive from it, never hand-list phase names.</span></span></code></pre>" }),
		"\n",
		createVNode("a", { id: "w5" }),
		"\n",
		createVNode(_components.h3, {
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/padi.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/padi.mdx";
