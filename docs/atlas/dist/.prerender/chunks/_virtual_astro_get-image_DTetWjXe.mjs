import { c as isRemotePath } from "./path_DR6eUnqp.mjs";
import { t as isRemoteAllowed } from "./remote_DDCxf2My.mjs";
import { B as RemoteImageNotAllowed, S as InvalidImageService, d as ExpectedNotESMImage, l as ExpectedImage, t as AstroError, u as ExpectedImageOptions } from "./errors_CqHSUxQm.mjs";
import { t as DEFAULT_HASH_PROPS } from "./consts_CexhJocf.mjs";
import { c as isRemoteImage, i as inferRemoteSize, l as resolveSrc, n as isLocalService, o as resolveDefaultOutputFormat, s as isESMImportedImage } from "./service_CNITpKEd.mjs";
//#region node_modules/.pnpm/astro@7.1.0_@emnapi+core@1.11.1_@emnapi+runtime@1.11.2_@types+node@22.19.19_rollup@4.61.0_yaml@2.9.0/node_modules/astro/dist/assets/layout.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.1.0_@emnapi+core@1.11.1_@emnapi+runtime@1.11.2_@types+node@22.19.19_rollup@4.61.0_yaml@2.9.0/node_modules/astro/dist/assets/types.js
function isImageMetadata(src) {
	return src.fsPath && !("fsPath" in src);
}
//#endregion
//#region node_modules/.pnpm/astro@7.1.0_@emnapi+core@1.11.1_@emnapi+runtime@1.11.2_@types+node@22.19.19_rollup@4.61.0_yaml@2.9.0/node_modules/astro/dist/assets/utils/url.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.1.0_@emnapi+core@1.11.1_@emnapi+runtime@1.11.2_@types+node@22.19.19_rollup@4.61.0_yaml@2.9.0/node_modules/astro/dist/assets/internal.js
var cssFitValues = [
	"fill",
	"contain",
	"cover",
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_dhWEsKeI.mjs").catch((e) => {
