...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"tsx\"><code><span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> { Xterm, </span><span style=\"color:#D73A49\">type</span><span style=\"color:#24292E\"> XtermHandle } </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit/solid\"</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#032F62\"> \"@xterm/xterm/css/xterm.css\"</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#005CC5\">Xterm</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  theme</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{dracula}                 </span><span style=\"color:#6A737D\">// reactive — live re-theme, texture atlas cleared</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  fontSize</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{</span><span style=\"color:#005CC5\">14</span><span style=\"color:#24292E\">}                   </span><span style=\"color:#6A737D\">// reactive — refit + atlas clear</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  fontFamily</span><span style=\"color:#D73A49\">=</span><span style=\"color:#032F62\">\"MonoLisa\"</span><span style=\"color:#6A737D\">           // the face awaited before construction</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  visible</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{props.visible}         </span><span style=\"color:#6A737D\">// fit gate: hidden panes wait at 80×24</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  webgl</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{() </span><span style=\"color:#D73A49\">=></span><span style=\"color:#6F42C1\"> underBudget</span><span style=\"color:#24292E\">()}     </span><span style=\"color:#6A737D\">// renderer gate — an accessor, never a snapshot</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  scrollLockEnabled</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{() </span><span style=\"color:#D73A49\">=></span><span style=\"color:#005CC5\"> true</span><span style=\"color:#24292E\">}  </span><span style=\"color:#6A737D\">// scroll-lock gate — an accessor (e.g. a pref)</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  onData</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{(</span><span style=\"color:#E36209\">bytes</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> pty.</span><span style=\"color:#6F42C1\">write</span><span style=\"color:#24292E\">(bytes)}                    </span><span style=\"color:#6A737D\">// keystrokes out</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  onResize</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{({ </span><span style=\"color:#E36209\">cols</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">rows</span><span style=\"color:#24292E\"> }) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> pty.</span><span style=\"color:#6F42C1\">resize</span><span style=\"color:#24292E\">(cols, rows)}   </span><span style=\"color:#6A737D\">// grid → PTY</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  onTap</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{(</span><span style=\"color:#E36209\">x</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">y</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#005CC5\"> false</span><span style=\"color:#24292E\">}         </span><span style=\"color:#6A737D\">// touch: what a tap MEANS is the consumer's</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  onReady</span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\">{(</span><span style=\"color:#E36209\">h</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> XtermHandle</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> pty.</span><span style=\"color:#6F42C1\">onData</span><span style=\"color:#24292E\">((</span><span style=\"color:#E36209\">c</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> h.</span><span style=\"color:#6F42C1\">write</span><span style=\"color:#24292E\">(c))} </span><span style=\"color:#6A737D\">// bytes in</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">/></span></span></code></pre>" }),
		"\n",
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> { createMirrorAnchor, snapToWrapHead } </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit\"</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> anchor</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#6F42C1\"> createMirrorAnchor</span><span style=\"color:#24292E\">(headless); </span><span style=\"color:#6A737D\">// pins onTrim, survives RIS buffer swaps</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// absolute line coordinates that survive eviction and reset:</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">const</span><span style=\"color:#005CC5\"> topLine</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#24292E\"> anchor.</span><span style=\"color:#6F42C1\">baseLine</span><span style=\"color:#24292E\">() </span><span style=\"color:#D73A49\">+</span><span style=\"color:#6F42C1\"> snapToWrapHead</span><span style=\"color:#24292E\">(buf, start);</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// anchor.reflowEpoch() stales any history cursor a width reflow renumbered</span></span></code></pre>" }),
		"\n",
		createVNode(_components.h2, {
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">  // mirror anchoring (the kaval half) + reattach discrimination — runtime-neutral</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  createMirrorAnchor,       </span><span style=\"color:#6A737D\">// absolute-line origin that survives eviction and RIS</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  snapToWrapHead,           </span><span style=\"color:#6A737D\">// never cut a serialize at a soft-wrap continuation</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  createSnapshotBoundary,   </span><span style=\"color:#6A737D\">// first-frame-is-snapshot vs live-delta discrimination</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">} </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit\"</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  createBackfillController, </span><span style=\"color:#6A737D\">// scroll-triggered older-history backfill; fetch injected</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  prependScrollback,        </span><span style=\"color:#6A737D\">// the fail-loud in-place prepend under the controller</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  defaultScratch,           </span><span style=\"color:#6A737D\">// the @xterm/xterm scratch the controller replays through</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">} </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit/backfill\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#6A737D\">// browser-only — constructs @xterm/xterm</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  renderService, readDecPrivateMode, readBufferBytes,</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  patchTransformAwareMouseCoords,</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">} </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit/internals\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#6A737D\">// cosmetic reads — degrade to null</span></span></code></pre>" }),
		"\n",
		createVNode(_components.ul, { children: [
			"\n",
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"tsx\"><code><span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  Xterm,                </span><span style=\"color:#6A737D\">// the component: lifecycle + addons + WebGL + fit, in JSX form (PR 2)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  createXtermLifecycle, </span><span style=\"color:#6A737D\">// the primitive under it, for a non-JSX composition (PR 2)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  attachWebGL,          </span><span style=\"color:#6A737D\">// single-owner WebglAddon lifetime + context-loss recovery (PR 2)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  createRenderRecovery, </span><span style=\"color:#6A737D\">// forced sync repaint when the rAF paint loop parks</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  wireScrollIntent,     </span><span style=\"color:#6A737D\">// DOM wheel/pointer wiring for the core scroll lock</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  createScrollLock,     </span><span style=\"color:#6A737D\">// freeze-while-reading latch; buffered writes keep their callbacks</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  enableSoftKeyboardInput, </span><span style=\"color:#6A737D\">// iOS contenteditable soft-keyboard surface</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  isCoarsePointer,      </span><span style=\"color:#6A737D\">// pointer:coarse media query (the touch gate)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">} </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit/solid\"</span><span style=\"color:#24292E\">;</span></span></code></pre>" }),
		"\n",
		createVNode(_components.ul, { children: [
			"\n",
			createVNode(_components.li, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"tsx\"><code><span class=\"line\"><span style=\"color:#D73A49\">import</span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  enableSoftKeyboardInput, </span><span style=\"color:#6A737D\">// contenteditable input surface — the iOS quirk knowledge, in one place</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  wireTouchTaps,           </span><span style=\"color:#6A737D\">// tap-vs-scroll discrimination; `onTap` is the policy hook</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  wireTouchScroll,         </span><span style=\"color:#6A737D\">// touch → scrollback bridge (xterm ships none); arms the scroll lock</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">} </span><span style=\"color:#D73A49\">from</span><span style=\"color:#032F62\"> \"@kolu/xterm-kit/solid\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#6A737D\">// `&#x3C;Xterm>` composes all three on touch devices</span></span></code></pre>" }),
		"\n",
		createVNode(_components.ul, { children: [
			"\n",
			createVNode(_components.li, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/xterm-kit.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/xterm-kit.mdx";
