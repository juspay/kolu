	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  fsReadFile (server)                     wire kind          BrowseFileDispatcher (client)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  ┌───────────────────────┐   text   ┌───────────────┐   →  BrowseFileView   (Pierre CodeView)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  │ isBinaryPreviewable(p) │ ───────▶ │ {kind:\"text\"} │" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  │   in previewable.ts    │   binary │ {kind:\"binary\"}│  →  BrowsePreviewView (<img> | video | PDF viewer | sandboxed iframe)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "                                       ▲ the single switch point — add a kind here" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  ── kolu app (the house) ───────────┐    ── the grid: reusable packages ──────────────────────" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   fsReadFile wire {kind, …}         │" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "        │ thin adapter (wire→props)  │     @kolu/solid-fileview  ── the outlet ──" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "        ▼                            │       <FileView source={…} rendered={[…]} />" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   <FileView                         │         owns: the Source ⇄ Rendered toggle," })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "      source={pierreRenderer}  ──────┼──▶       which modes exist, registry.pick(path)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "      rendered={[md, img, iframe]} ──┼──▶     RenderedRenderer = { match, render }  ← appliances" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "        ▲ kolu injects its renderers │     @kolu/solid-markdown  ── an appliance ──" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "          (theme, comment bridge)    │       <Markdown variant=\"document\" />  (marked + sanitize)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  ───────────────────────────────────┘     @kolu/solid-pierre   ── already a package (source) ──" })
				})
			] })
		}),
		"\n",
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ", content, truncated, url }"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//        ^source view ──────────┘          └── iframe render"
					})
				})
			] })
		}),
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/solid-fileview.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/solid-fileview.mdx";
