...
`
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>applyLocation(loc)            // the existing batch(openCodeAt + reveal + setPending) — \"assign\"</span></span>\n<span class=\"line\"><span>navigate(loc)  = applyLocation(loc) + history.push(loc)   // address-bar navigation</span></span>\n<span class=\"line\"><span>back()         = applyLocation(history.back())            // traverse — NO push</span></span>\n<span class=\"line\"><span>forward()      = applyLocation(history.forward())         // traverse — NO push</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/solid-browser.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/solid-browser.mdx";
