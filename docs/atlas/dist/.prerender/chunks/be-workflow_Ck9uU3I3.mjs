	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.ol, { children: [
			...
			createVNode(_components.li, { children: [
				...
				" — report the PR, the gauntlet outcome, and CI status. ",
				createVNode(_components.code, { children: "/be" }),
				" ",
				createVNode(_components.em, { children: "never\nmerges" }),
				"; the human reviews the commits and merges when satisfied. Then it runs\n",
				createVNode(Skill, { name: "self-improve" }),
				" to mine the session for recurring friction."
			] }),
			"\n"
		] }),
		"\n",
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/be-workflow.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/be-workflow.mdx";
