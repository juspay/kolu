	...
	return createVNode(Fragment, { children: [
		...
		createVNode($$Callout, {
			...
			children: [
				...
				createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">type</span><span style=\"color:#6F42C1\"> Seq</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#005CC5\"> number</span><span style=\"color:#24292E\">;   </span><span style=\"color:#6A737D\">// monotonic byte-sequence position in the stream</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">type</span><span style=\"color:#6F42C1\"> Row</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#005CC5\"> number</span><span style=\"color:#24292E\">;   </span><span style=\"color:#6A737D\">// stable, never-renumbered absolute scrollback line</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">type</span><span style=\"color:#6F42C1\"> Record</span><span style=\"color:#D73A49\"> =</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">kind</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"data\"</span><span style=\"color:#24292E\">;   </span><span style=\"color:#E36209\">seq</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Seq</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">firstRow</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Row</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">bytes</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Uint8Array</span><span style=\"color:#24292E\"> }  </span><span style=\"color:#6A737D\">// a decoded PTY output chunk</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">kind</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"resize\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">seq</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Seq</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">cols</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> number</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">rows</span><span style=\"color:#D73A49\">:</span><span style=\"color:#005CC5\"> number</span><span style=\"color:#24292E\"> }        </span><span style=\"color:#6A737D\">// the out-of-band grid change, at its true position</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  |</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">kind</span><span style=\"color:#D73A49\">:</span><span style=\"color:#032F62\"> \"ckpt\"</span><span style=\"color:#24292E\">;   </span><span style=\"color:#E36209\">seq</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Seq</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">row</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Row</span><span style=\"color:#24292E\">; </span><span style=\"color:#E36209\">vtState</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Uint8Array</span><span style=\"color:#24292E\"> };    </span><span style=\"color:#6A737D\">// periodic VT-state seed: serialize({ scrollback: 0 })</span></span></code></pre>" }),
				createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>┌──────────────────────────────────────────────────────────────────────────────┐</span></span>\n<span class=\"line\"><span>│  ⏱  History — claude-code (feat/female-flat)      [Aa] [.*]  Find… 3/57  ‹  › │</span></span>\n<span class=\"line\"><span>│                                          Jump ▾    ⤓ PDF              ✕  Esc    │</span></span>\n<span class=\"line\"><span>├──────────────────────────────────────────────────────────────────────────────┤</span></span>\n<span class=\"line\"><span>│ ····· Older output trimmed to stay under the 256 MB history limit ··········· │  ← evicted sentinel</span></span>\n<span class=\"line\"><span>│  $ pnpm test                                                                   │</span></span>\n<span class=\"line\"><span>│  ✓ packages/kaval   (42)                                                       │</span></span>\n<span class=\"line\"><span>│  ✓ packages/shared  (18)                                                       │     read-only xterm</span></span>\n<span class=\"line\"><span>│  …                                                                             │     (DOM renderer, no WebGL)</span></span>\n<span class=\"line\"><span>│  $ git log --oneline -5                                                        │     fixed width = pager cols</span></span>\n<span class=\"line\"><span>│  3eb6cc8  fix(kaval): defang the reconnect storm (#1573)                       │     text is selectable → copy</span></span>\n<span class=\"line\"><span>│  ▓▓▓ match: \"reconnect storm\" highlighted in view ▓▓▓                          │</span></span>\n<span class=\"line\"><span>│  …                                                                             │</span></span>\n<span class=\"line\"><span>│                                                                                │</span></span>\n<span class=\"line\"><span>├──────────────────────────────────────────────────────────────────────────────┤</span></span>\n<span class=\"line\"><span>│  line ~1,284,330 · 3 days ago · 132 cols                ↓ Jump to live   ◴ new │  ← footer; ◴ ring pulses</span></span>\n<span class=\"line\"><span>└──────────────────────────────────────────────────────────────────────────────┘</span></span>\n<span class=\"line\"><span></span></span>\n<span class=\"line\"><span>  Top-sentinel variants (whichever applies as you scroll up):</span></span>\n<span class=\"line\"><span>    backfilling →   ····· ⠋ loading older history… ·····</span></span>\n<span class=\"line\"><span>    true start  →   ──────────── Beginning of session ────────────</span></span>\n<span class=\"line\"><span>    disabled    →   History isn't being recorded for this terminal.</span></span>\n<span class=\"line\"><span>    disk fault  →   ⚠ History may be incomplete — disk error; showing up to the last good point.</span></span>\n<span class=\"line\"><span></span></span>\n<span class=\"line\"><span>  Jump ▾ menu (anchored popover):     Search field toggles:</span></span>\n<span class=\"line\"><span>    ┌──────────────────────┐           [Aa] case-sensitive   [.*] regex</span></span>\n<span class=\"line\"><span>    │ ⤒  Top of history    │           (chips inside the field, ripgrep-style)</span></span>\n<span class=\"line\"><span>    │ ⤓  Latest            │</span></span>\n<span class=\"line\"><span>    │ ─────────────────    │</span></span>\n<span class=\"line\"><span>    │ 🕘 1 hour ago        │           NOTE: no \"jump to line N\" — render-line</span></span>\n<span class=\"line\"><span>    │ 🕘 Today 09:00       │           numbers shift under reflow, so the only</span></span>\n<span class=\"line\"><span>    │ 🕘 Yesterday         │           position anchors are TIME and top/latest</span></span>\n<span class=\"line\"><span>    │ 🕘 Pick a time…      │           (the byte-offset cursor is opaque).</span></span>\n<span class=\"line\"><span>    └──────────────────────┘</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>              ▁▁▁▁▁▁                                   ← grabber (w-10 h-1 rounded-full)</span></span>\n<span class=\"line\"><span>   ┌────────────────────────────────────────────┐</span></span>\n<span class=\"line\"><span>   │ ⏱ History                 Find…    ⤓    ✕   │     header — each control ≥44px</span></span>\n<span class=\"line\"><span>   │ claude-code · feat/female-flat              │</span></span>\n<span class=\"line\"><span>   │ [ Top ]  [ Latest ]  [ Jump to time ▾ ]     │     jump row (full-width buttons)</span></span>\n<span class=\"line\"><span>   ├────────────────────────────────────────────┤</span></span>\n<span class=\"line\"><span>   │ $ pnpm test                                 │</span></span>\n<span class=\"line\"><span>   │ ✓ packages/kaval (42)                       │     read-only xterm</span></span>\n<span class=\"line\"><span>   │ …                                           │     native touch scroll;</span></span>\n<span class=\"line\"><span>   │ ▓ match highlighted ▓                       │     backfills on scroll-near-top</span></span>\n<span class=\"line\"><span>   │ …                                           │</span></span>\n<span class=\"line\"><span>   │                                             │</span></span>\n<span class=\"line\"><span>   ├────────────────────────────────────────────┤</span></span>\n<span class=\"line\"><span>   │  line ~1,284,330 · 3 days ago               │</span></span>\n<span class=\"line\"><span>   │        ↓   Jump to live   ◴                 │     big target, ring pulses on new output</span></span>\n<span class=\"line\"><span>   └────────────────────────────────────────────┘</span></span>\n<span class=\"line\"><span>        (Drawer.Overlay backdrop dims the tile behind)</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/kaval-memory-architecture.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/kaval-memory-architecture.mdx";
