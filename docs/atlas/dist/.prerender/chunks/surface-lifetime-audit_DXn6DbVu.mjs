	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.ul, { children: [
			...
			createVNode(_components.li, { children: [
				...
				" by the\nper-timer census in ",
				createVNode(_components.a, {
					href: "session-timer-unref.html",
					children: "session-timer-unref"
				}),
				" —\n",
				createVNode(_components.code, { children: "unref()" }),
				" on the backoff/watchdog/probe timers (an abandoned session can no\nlonger immortalize its host process), with the admit-handshake timeout\ndeliberately kept ref’d (it settles a caller-awaited ",
				createVNode(_components.code, { children: "pin()" }),
				"); the fuller\nparent-binding (boundToPid-style auto-destroy) still waits for a real\nconsumer bite."
			] }),
			"\n"
		] }),
		"\n",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-lifetime-audit.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-lifetime-audit.mdx";
