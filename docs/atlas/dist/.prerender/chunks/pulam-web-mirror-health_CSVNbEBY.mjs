...
` }),
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// @kolu/surface-nix-host/connection — browser-safe (zod + @kolu/surface only)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// Gate-closed by default: a freshly-composed cell reads \"connecting\", so"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// \"healthy-empty before the first frame\" is structurally unrepresentable."
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// The composable cell — the fragment `mirroredSurface(base)` spreads in at the"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// mirror seam; apps compose via `mirroredSurface`, never hand-spread this."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// `verbs: [\"get\"]` makes it READ-ONLY over the wire: the parent host owns it"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// (writes server-side off `session.onState`), so a remote client must never be"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// able to `connection.set` the health to `connected` and forge the gate's"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// signal. Without it, a no-`patchSchema` cell defaults to `[\"get\", \"set\"]`."
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  schema: ConnectionInfoSchema,"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// @kolu/surface-nix-host (node main entry)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  lastError: s.lastError,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  failureCause: s.failureCause,"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// The dual of pumpRemoteSurface (which streams DATA out); this streams STATE"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// out. Returns the unsubscribe."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " pipeSessionStateToCell"
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: " ="
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// packages/pulam-web/src/shared/contract.ts"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: " \"@kolu/surface-nix-host/connection\""
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ";"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " { terminalWorkspaceSurface } "
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: "from"
						...
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: " \"@kolu/terminal-workspace/surface\""
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ";"
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// The browser-facing surface = base + the get-only `connection` cell."
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// packages/pulam-web/src/server/reserve.ts — re-serve of the MIRRORED surface"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// gate-closed \"connecting\" seed"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  cells: { version: { store: versionStore }, connection },"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // collections / streams folded/forwarded from the daemon's base surface…"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// Expose the framework-wrapped setter on the ReServe result:"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " fragment.ctx.cells.connection."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "set"
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// packages/pulam-web/src/server/hostEntry.ts"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " buildReServe"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ log: hostLog });"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  source: terminalWorkspaceSurface,"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // …live holders + onLinkDown reset…"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  connection: { set: reServe.setConnection }, "
					}), createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ← pump wires pipeSessionStateToCell"
					})]
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "// packages/pulam-web/src/client/HostGroup.tsx" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "const connection = app.cells.connection.use({ onError });" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "const info = (): ConnectionInfo => connection.value() ?? DEFAULT_CONNECTION;" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "<Show" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  when={info().state === \"connected\"}" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  fallback={<ConnectionView info={info()} host={props.host} />}" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  {/* the existing awareness rendering — \"no terminals\" is honest only here */}" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/pulam-web-mirror-health.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/pulam-web-mirror-health.mdx";
