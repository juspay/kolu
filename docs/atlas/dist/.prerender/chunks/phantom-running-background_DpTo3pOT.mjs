...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"bash\"><code><span class=\"line\"><span style=\"color:#6F42C1\">$</span><span style=\"color:#032F62\"> F=~/.claude/projects/-home-srid-code-kolu--worktrees-reload-html/c43efadd-….jsonl</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\"># newest real assistant message → end_turn (this alone = \"waiting\", no spinner)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">{</span><span style=\"color:#6F42C1\">\"type\"</span><span style=\"color:#005CC5\">:</span><span style=\"color:#6F42C1\">\"assistant\"</span><span style=\"color:#6F42C1\">,</span><span style=\"color:#6F42C1\">\"stop_reason\"</span><span style=\"color:#005CC5\">:</span><span style=\"color:#6F42C1\">\"end_turn\"</span><span style=\"color:#6F42C1\">,</span><span style=\"color:#6F42C1\">\"ts\"</span><span style=\"color:#005CC5\">:</span><span style=\"color:#6F42C1\">\"2026-06-01T22:29:26.464Z\"</span><span style=\"color:#6F42C1\">}</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\"># but line 1177 launched a background command, and it never completed:</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">$</span><span style=\"color:#032F62\"> grep</span><span style=\"color:#005CC5\"> -o</span><span style=\"color:#032F62\"> 'Command running in background with ID: [a-z0-9]*'</span><span style=\"color:#032F62\"> \"</span><span style=\"color:#24292E\">$F</span><span style=\"color:#032F62\">\"</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">Command</span><span style=\"color:#032F62\"> running</span><span style=\"color:#032F62\"> in</span><span style=\"color:#032F62\"> background</span><span style=\"color:#032F62\"> with</span><span style=\"color:#032F62\"> ID:</span><span style=\"color:#032F62\"> bi8olsr8z</span><span style=\"color:#6A737D\">          # `just ai::apm >/tmp/apm2.log 2>&#x26;1`, auto-backgrounded</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">$</span><span style=\"color:#032F62\"> grep</span><span style=\"color:#005CC5\"> -c</span><span style=\"color:#032F62\"> 'task-id>bi8olsr8z'</span><span style=\"color:#032F62\"> \"</span><span style=\"color:#24292E\">$F</span><span style=\"color:#032F62\">\"</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">0</span><span style=\"color:#6A737D\">                                                          # ← zero completions for this id, anywhere in 3.6 MB</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">$</span><span style=\"color:#032F62\"> grep</span><span style=\"color:#005CC5\"> -oE</span><span style=\"color:#032F62\"> '&#x3C;status>completed&#x3C;/status>'</span><span style=\"color:#032F62\"> \"</span><span style=\"color:#24292E\">$F</span><span style=\"color:#032F62\">\"</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#6F42C1\"> wc</span><span style=\"color:#005CC5\"> -l</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">17</span><span style=\"color:#6A737D\">                                                         # 17 completions exist — all for OTHER task ids</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"diff\"><code><span class=\"line\"><span style=\"color:#24292E\">// packages/integrations/claude-code/src/core.ts — deriveState (383-386)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  let state = stateAndModel.state;</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  if (state === \"waiting\") {</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">    const bg = outstanding ?? outstandingBackgroundTasks(lines);</span></span>\n<span class=\"line\"><span style=\"color:#B31D28\"><span style=\"user-select: none;\">-</span>   if (bg.length > 0) state = \"running_background\";</span></span>\n<span class=\"line\"><span style=\"color:#22863A\"><span style=\"user-select: none;\">+</span>   if (bg.some((t) => t.runId !== null)) state = \"running_background\";  // Workflow runs only — Bash/Agent have no journal</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  }</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
			createVNode(_components.code, { children: "outstandingBackgroundTasks" }),
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// core.ts — outstandingBackgroundTasks (441-487), sketch of the layered veto</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  const</span><span style=\"color:#005CC5\"> launched</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#D73A49\"> new</span><span style=\"color:#6F42C1\"> Map</span><span style=\"color:#24292E\">();      </span><span style=\"color:#6A737D\">// taskId → { runId, index, atMs }</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  const</span><span style=\"color:#005CC5\"> completed</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#D73A49\"> new</span><span style=\"color:#6F42C1\"> Set</span><span style=\"color:#24292E\">();</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  let</span><span style=\"color:#24292E\"> newestMs </span><span style=\"color:#D73A49\">=</span><span style=\"color:#005CC5\"> null</span><span style=\"color:#24292E\">;             </span><span style=\"color:#6A737D\">// newest timestamp across ALL entries (metadata too)</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  let</span><span style=\"color:#24292E\"> lastHumanTurn </span><span style=\"color:#D73A49\">=</span><span style=\"color:#D73A49\"> -</span><span style=\"color:#005CC5\">1</span><span style=\"color:#24292E\">;          </span><span style=\"color:#6A737D\">// index of the newest genuine human prompt</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#24292E\">  lines.</span><span style=\"color:#6F42C1\">forEach</span><span style=\"color:#24292E\">((</span><span style=\"color:#E36209\">raw</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">i</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> {</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    let</span><span style=\"color:#24292E\"> entry; </span><span style=\"color:#D73A49\">try</span><span style=\"color:#24292E\"> { entry </span><span style=\"color:#D73A49\">=</span><span style=\"color:#005CC5\"> JSON</span><span style=\"color:#24292E\">.</span><span style=\"color:#6F42C1\">parse</span><span style=\"color:#24292E\">(raw); } </span><span style=\"color:#D73A49\">catch</span><span style=\"color:#24292E\"> { </span><span style=\"color:#D73A49\">return</span><span style=\"color:#24292E\">; }</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    const</span><span style=\"color:#005CC5\"> ms</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#24292E\"> Date.</span><span style=\"color:#6F42C1\">parse</span><span style=\"color:#24292E\">(entry.timestamp </span><span style=\"color:#D73A49\">??</span><span style=\"color:#032F62\"> \"\"</span><span style=\"color:#24292E\">);                 </span><span style=\"color:#6A737D\">// NaN-safe</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (</span><span style=\"color:#D73A49\">!</span><span style=\"color:#24292E\">Number.</span><span style=\"color:#6F42C1\">isNaN</span><span style=\"color:#24292E\">(ms)) newestMs </span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\"> Math.</span><span style=\"color:#6F42C1\">max</span><span style=\"color:#24292E\">(newestMs </span><span style=\"color:#D73A49\">??</span><span style=\"color:#24292E\"> ms, ms);</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (entry.type </span><span style=\"color:#D73A49\">===</span><span style=\"color:#032F62\"> \"queue-operation\"</span><span style=\"color:#24292E\">) { </span><span style=\"color:#6A737D\">/* …completed.add(id)… */</span><span style=\"color:#D73A49\"> return</span><span style=\"color:#24292E\">; }</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (entry.type </span><span style=\"color:#D73A49\">!==</span><span style=\"color:#032F62\"> \"user\"</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">return</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (</span><span style=\"color:#6F42C1\">isGenuineHumanTurn</span><span style=\"color:#24292E\">(entry)) lastHumanTurn </span><span style=\"color:#D73A49\">=</span><span style=\"color:#24292E\"> i;             </span><span style=\"color:#6A737D\">// real prompt, not machinery</span></span>\n<span class=\"line\"><span style=\"color:#6A737D\">    // …launched.set(taskId, { runId, index: i, atMs }) …</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  });</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  const</span><span style=\"color:#005CC5\"> out</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#24292E\"> [];</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  for</span><span style=\"color:#24292E\"> (</span><span style=\"color:#D73A49\">const</span><span style=\"color:#24292E\"> [</span><span style=\"color:#005CC5\">taskId</span><span style=\"color:#24292E\">, { </span><span style=\"color:#005CC5\">runId</span><span style=\"color:#24292E\">, </span><span style=\"color:#005CC5\">index</span><span style=\"color:#24292E\">, </span><span style=\"color:#005CC5\">atMs</span><span style=\"color:#24292E\"> }] </span><span style=\"color:#D73A49\">of</span><span style=\"color:#24292E\"> launched) {</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (completed.</span><span style=\"color:#6F42C1\">has</span><span style=\"color:#24292E\">(taskId)) </span><span style=\"color:#D73A49\">continue</span><span style=\"color:#24292E\">;</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (atMs </span><span style=\"color:#D73A49\">!==</span><span style=\"color:#005CC5\"> null</span><span style=\"color:#D73A49\"> &#x26;&#x26;</span><span style=\"color:#24292E\"> newestMs </span><span style=\"color:#D73A49\">!==</span><span style=\"color:#005CC5\"> null</span><span style=\"color:#D73A49\"> &#x26;&#x26;</span><span style=\"color:#24292E\"> newestMs </span><span style=\"color:#D73A49\">-</span><span style=\"color:#24292E\"> atMs </span><span style=\"color:#D73A49\">></span><span style=\"color:#005CC5\"> STALE_BG_MS</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">continue</span><span style=\"color:#24292E\">;  </span><span style=\"color:#6A737D\">// staleness</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">    if</span><span style=\"color:#24292E\"> (lastHumanTurn </span><span style=\"color:#D73A49\">></span><span style=\"color:#24292E\"> index) </span><span style=\"color:#D73A49\">continue</span><span style=\"color:#24292E\">;                                                </span><span style=\"color:#6A737D\">// human spoke after</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">    out.</span><span style=\"color:#6F42C1\">push</span><span style=\"color:#24292E\">({ taskId, runId });</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  }</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">  return</span><span style=\"color:#24292E\"> out;</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/phantom-running-background.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/phantom-running-background.mdx";
