	...
	return createVNode(Fragment, { children: [
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//  snapshot half  ── @kolu/terminal-workspace, served as `terminalWorkspace.awareness`"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//  authored half  ── @kolu/common, served as `kolu.authored`"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//  the join  ── NOT served · computed at the reader and at save · a z.infer type, not a value"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " SleepingTerminal"
						}),
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "       // = compose(authored, awareness)"
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "composeTerminalMetadata(authored, awareness):" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  active    →  { ...awareness, ...authored }                 // authored wins; full live overlay" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  sleeping  →  { ...persisted(awareness), ...authored }       // live half (pr·agent·foreground)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "                                                              // dropped; authored's frozen pr is" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "                                                              // the only pr a sleeping tile shows" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  ACTIVE                                       SLEEPING" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  PTY alive · sensors live                     PTY killed · live sensors stop" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  awareness updates each tick                  entry + awareness KEPT (frozen)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  join = { ...awareness, ...authored }         authored flipped to sleeping IN PLACE" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  full live overlay (pr·agent·fg)              join = persisted(awareness) + authored" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "                                               frozen pr only · pr·agent·fg dropped" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "key  =  ( location , TerminalId )" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  TerminalId   a uuid · minted by kolu-server, passed verbatim to kaval, keys BOTH collections" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  location     { kind:\"local\" } | { kind:\"remote\", hostId }   — lives in AuthoredTerminal" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "S1   memoryless producer:  taps → TerminalEvent events  (TerminalSnapshot: cwd·git·pr·agent·foreground)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "S2   kolu's fold:          { cache, memory, live } patches · kolu's clock · memory → kolu.authored" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "R9.0 kolu runs the producer IN-PROCESS and folds            (R9·lib / createPulam dissolved)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "R9.3 kolu SUBSCRIBES a remote producer's event stream into the SAME fold  (no reconcile)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "     UNCHANGED:  the reader join (composeTerminalMetadata) · disk persistence" })
				})
			] })
		}),
		"\n",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/terminal-metadata-model.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/terminal-metadata-model.mdx";
