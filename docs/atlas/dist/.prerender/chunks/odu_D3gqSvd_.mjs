			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// .mcp.json — Claude Code; Codex, opencode & Gemini CLI take the same shape (kolu's committed entry wraps this via the odu-mcp skill's bin/serve)"
					})
				}),
				"\n",
				createVNode(_components.span, {
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/odu.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/odu.mdx";
