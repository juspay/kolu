	...
	return createVNode(Fragment, { children: [
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// the relationship to the server you're bound to:"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// \"live\" | \"reconnecting\" | \"restarted\" | \"down\""
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// boolean — running bundle is behind the server's build"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// T | undefined — what am I bound to (default { commit }; kolu extends)"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "app.clientCommit    "
					}), createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// string — this bundle's baked-in commit"
					})]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// land the deployed build"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// OS app badge if installed (best-effort) + document.title — degrades per browser"
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// default — drishti uses exactly this"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " clientIsStale"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(srv.commit, cli.commit),"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// kolu extends — adds the pty-host axis without losing the commit one"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(), ptyHost: PtyHostRefSchema }),"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " ptyHostDiverged"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(srv.ptyHost, cli.ptyHost) });"
						})
					]
				})
			] })
			...
			children: createVNode(_components.pre, {
				...
				children: createVNode(_components.code, { children: [
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// server — a hand-written cell store, and a hand-rolled /sw.js route"
						})
					}),
					"\n",
					createVNode(_components.span, {
					...
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// vite.config — a sha literal (!) and a per-app define"
						})
					}),
					"\n",
					createVNode(_components.span, {
					...
					createVNode(_components.span, {
						...
						children: [
							...
							createVNode(_components.span, {
								style: { color: "#6F42C1" },
								children: "__SURFACE_APP_COMMIT__"
							}),
							createVNode(_components.span, {
								style: { color: "#24292E" },
								children: ": "
					...
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// env.d.ts — the global's type, redeclared per app"
						})
					}),
					"\n",
					createVNode(_components.span, {
			...
			children: createVNode(_components.pre, {
				...
				children: createVNode(_components.code, { children: [
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// surface — ONE merge: the buildInfo cell + the surfaceApp.info probe + your own spec"
						})
					}),
					"\n",
					createVNode(_components.span, {
						...
						children: [
							...
							createVNode(_components.span, {
								style: { color: "#6F42C1" },
								children: "composeSurfaces"
							}),
							createVNode(_components.span, {
								style: { color: "#24292E" },
								children: "(surfaceAppSurface, { cells: {"
							}),
							createVNode(_components.span, {
								style: { color: "#6A737D" },
								children: "/* yours */"
					...
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// server — ONE call: merges the surface-app impls, runs implementSurface, flows buildInfo.connect; then serve shell + manifest + /sw.js"
						})
					}),
					"\n",
					createVNode(_components.span, {
						...
						children: [
							...
							createVNode(_components.span, {
								style: { color: "#6F42C1" },
								children: "surfaceAppServer"
							}),
							createVNode(_components.span, {
								style: { color: "#24292E" },
								children: "(), { channel, cells: {"
							}),
							createVNode(_components.span, {
								style: { color: "#6A737D" },
								children: "/* yours */"
					...
					createVNode(_components.span, {
						...
						children: [createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "installSurfaceApp"
						}), createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(app, { clientDist, manifest });"
						})]
					}),
					"\n",
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// vite.config — one plugin resolves the commit (git/env), injects the define, ships its type"
						})
					}),
					"\n",
					createVNode(_components.span, {
					...
					createVNode(_components.span, {
						...
						children: createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// env.d.ts — deleted. no define, no sha literal, no hand-rolled routes, no hand-spread fragments."
						})
					})
				] })
			})
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// `implementSurfaceApp` — the server-side counterpart to `composeSurfaces`: ONE"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// call merges the fragment's buildInfo cell + `surfaceApp.info` probe impls into"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// your own deps, runs implementSurface, and flows `buildInfo.connect` internally."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// The app passes only its OWN cells/procedures — no hand-spread, no seed→connect."
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// one call serves the shell fresh + the manifest + /sw.js (retirement). Granular pieces exported too."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(app, { clientDist, manifest: { name: "
						}),
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: "`Kolu [${"
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " { surfaceAppSurface, composeSurfaces } "
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: "from"
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ONE merge: the buildInfo cell + the `surfaceApp.info` restart probe, composed"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// with your own spec. (`surfaceAppSurfaceWith(myBuildInfoDef)` for an extender.)"
					})
				}),
				"\n",
				createVNode(_components.span, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " { retireServiceWorker, SurfaceAppProvider, useSurfaceApp } "
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: "from"
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// pass your control-plane client + this bundle's baked commit (the bundler define):"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#005CC5" },
							children: "SurfaceAppProvider"
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " controlPlane"
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: "="
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "{__SURFACE_APP_COMMIT__}> …your app… </"
						}),
						createVNode(_components.span, {
							style: { color: "#005CC5" },
							children: "SurfaceAppProvider"
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// then render your own chrome from useSurfaceApp() — README has the snippets."
					})
				})
			] })
		}),
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// Vite path — the plugin resolves + injects the commit"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: " \"@kolu/surface-app/vite\""
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ";"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// injects __SURFACE_APP_COMMIT__ + ships its type — no define, no env.d.ts, no sha literal."
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// Bun path — buildSurfaceClient owns hash-naming + the define + the no-store shell rewrite"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ entrypoint, distDir, htmlTemplate, entryHtmlPlaceholder, plugins, extraAssets, publicDir });"
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// drishti — surface: ONE merge of surface-app's fragment (cell + surfaceApp.info probe) + its own"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(surfaceAppSurface, { collections: { hosts }, procedures: { hosts } }));"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// drishti — server: ONE call composes the surface-app impls (buildInfo cell + surfaceApp.info probe)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// into the app's own deps, runs implementSurface, and flows the cell's connect (commit auto-resolved; /sw.js served by the lib)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(), { channel, collections: { hosts }, procedures: { hosts } });"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// drishti — vite: one plugin resolves + injects the commit"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// drishti — client: provider (this bundle's baked commit) + your own chrome from useSurfaceApp()"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: createVNode(_components.span, {
				class: "line",
				children: createVNode(_components.span, { children: "● SRV d5aed3c · CLIENT 617b80d   [≠ srv]   ⟳ Reload" })
			}) })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "⟳  A new version is available" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   This tab is running an older build (617b80d → d5aed3c).        [ Reload ]" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// each is a normal, standalone surface — ZERO change to defineSurface / derivation / client proxy"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ cells: { buildInfo }, procedures: { identity: { info } } });"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ collections: { hosts }, procedures: { hosts } });"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ONE keyed map — the single (browser-safe) source of which surfaces exist under which keys"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " { surfaceApp: surfaceAppSurface, admin: adminSurface };"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " composeSurfaceContracts"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(surfaces);   "
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// → { surface: { surfaceApp, admin } }"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// SERVER — reuse `surfaces`; add only the server-only deps, keyed the same way (no { surface, deps } wrapper)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " implementSurfaces"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(surfaces, { channel }, {"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// the lib's deps bundle; its async buildInfo connect fires in the runtime"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// CLIENT — reuse `surfaces`; one connection split into a per-key client bundle"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " surfaceClients"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(link, surfaces);"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "c.surfaceApp.cells.buildInfo."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "use"
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// surface.surfaceApp.buildInfo"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "c.admin.collections.hosts."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "use"
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 1. namespace each surface's channel bus by its key so two surfaces' `buildInfo:changed` can't collide"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "walkSurface"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(t.surface[key], surface, { "
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: "..."
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 2. key each surface's router + ctx under its registration name (instead of the hardcoded single `surface`)"
					})
				})
			] })
		}),
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-app.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-app.mdx";
