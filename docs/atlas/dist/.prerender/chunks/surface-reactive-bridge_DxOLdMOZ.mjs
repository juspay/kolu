			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// Accessor via Solid store, reconciled"
						})
					]
				}),
				"\n",
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// poll: T+0 seed; a failing FIRST read crashes boot"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// the caller owns the cadence"
						})
					]
				}),
				"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// durable: scan(clicks, (stored) => stored ?? 0, step, { store: conf })"
					})
				})
			] })
		}),
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(frames.value));  "
						}),
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// never on the wire"
						})
					]
				}),
				"\n",
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// any graph node (the scan above)"
						})
					]
				}),
				"\n",
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ read: readProcessTable, install: everySecond })),"
						})
					]
				}),
				"\n",
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// $.someCollection(): ReadonlyMap<K,T>"
						})
					]
				}),
				"\n",
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [createVNode(_components.span, {
						...
						style: { color: "#6A737D" },
						children: "// one frame → one recompute per derivation"
					})]
				})
			] })
		}),
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // spec unchanged: equals: urgencyEqual stays the ONE wire dedup point"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // durability CHOICE: no store — alerts deliberately do NOT survive restart;"
					})
				}),
				"\n",
				createVNode(_components.span, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "wireSubscriptionUpdated"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(alerts.sub, () "
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// fires iff spec-equals said \"changed\""
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "    read: samplePadiMemory,   "
					}), createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// pure async read RETURNING {padi, kaval} — the honest"
					})]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "                              // three-way inside pollKavalRss survives verbatim"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#005CC5" },
							children: "MEMORY_SAMPLE_INTERVAL_MS"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ");"
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// snapshot-then-delta seeds sync"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// linkFor memo eviction rides exit"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ReadonlySignal<ReadonlyMap<string, SessionState>> — last-frame hold, membership diff,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// per-key disposal, per-member error isolation (d3): ALL bridge-owned, once."
					})
				}),
				"\n",
				createVNode(_components.span, { class: "line" }),
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// resolveEntry = projectState (:52-77, verbatim, undefined→connecting arm intact)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//              + causeFor + offsetOf + the #1716 belt, composed pure"
					})
				})
			] })
		}),
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// reads the DERIVED sibling"
						})
					]
				}),
				"\n",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-reactive-bridge.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-reactive-bridge.mdx";
