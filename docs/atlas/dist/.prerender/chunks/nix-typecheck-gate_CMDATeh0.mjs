	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.ul, { children: [
			...
			createVNode(_components.li, { children: [
				...
				" node directly builds every current-system flake output (",
				createVNode($$Cite, {
					file: "ci/mod.just",
					lines: "86-115"
				}),
		...
		"\n",
		createVNode(_components.p, { children: [
			"The full-output builder runs ",
			createVNode(_components.code, { children: "checks.${system}" }),
			" on every CI system. TypeScript typecheck is platform-independent, so attaching it to all three triples CI cost for identical results. Pin it to one — following the existing precedent ",
			createVNode($$Cite, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						...
						children: [createVNode(_components.span, {
							...
							children: "+"
						}), "# typecheck the whole workspace as a cached, full-output-CI-gated proof."]
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.p, { children: [
			...
			") noting that ",
			createVNode(_components.code, { children: "checks.typecheck" }),
			" (built there through direct enumeration) replaced the standalone recipe — so the temporal coupling (“the ",
			createVNode(_components.code, { children: "nix" }),
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "   pnpm --filter kolu-client build"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode($$Callout, {
			...
			children: createVNode(_components.p, { children: [
				...
				createVNode(_components.code, { children: "ci::nix" }),
				" full-output build; the standalone ",
				createVNode(_components.code, { children: "ci::typecheck" }),
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/nix-typecheck-gate.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/nix-typecheck-gate.mdx";
