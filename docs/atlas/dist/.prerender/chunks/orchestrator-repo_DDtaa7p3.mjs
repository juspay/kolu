...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>git clone https://github.com/srid/orchestrator ~/code/orchestrator</span></span>\n<span class=\"line\"><span># open a kolu terminal in your project, load /orchestrator, dispatch your first lane</span></span>\n<span class=\"line\"><span># open &#x3C;orchestrator>/dashboard/index.html in the Code tab → the live board</span></span></code></pre>" }),
		"\n",
		createVNode($$Svg, {
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/orchestrator-repo.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/orchestrator-repo.mdx";
