					...
					children: createVNode(_components.code, { children: [
						createVNode(_components.span, {
							...
							children: createVNode(_components.span, {
								style: { color: "#6A737D" },
								children: "// surface-mcp infers the legal keys & values from your spec."
							})
						}),
						"\n",
						createVNode(_components.span, {
							...
							children: createVNode(_components.span, {
								style: { color: "#6A737D" },
								children: "// `mutates` is optional but defaults CONSERVATIVELY: absent ⇒ mutating/destructive"
							})
						}),
						"\n",
						createVNode(_components.span, {
							...
							children: createVNode(_components.span, {
								style: { color: "#6A737D" },
								children: "// (a host could auto-run a read-only-hinted tool unconfirmed); mark a read-only tool `mutates: false`."
							})
						}),
						"\n",
						createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// odu mcp, rebuilt on the package (proposed shape)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// a curated projection — see below"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // BRIDGE the live coordinator — `unixSocketLink` returns `{ client, dispose }`,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // an owned connection the adapter closes on teardown / re-dials after a drop."
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  surface: oduAgentSurface,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // 1:1 surface primitives → resources & tools (default-deny allowlist)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// cell   → odu://nodes  (+ live notifications)"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// stream → odu://log/{node}  (bounded, path-guarded)"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// event  → fail-fast \"wait until done / first red\""
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// procedure → rerun one node + dependents"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // bespoke, MCP-call-shaped tools — compose over the live client, share the spine"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [createVNode(_components.span, {
						...
						style: { color: "#6A737D" },
						children: "// genuinely imperative: spawn + await the socket"
					})]
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " spawnAndAwait"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(args, signal),"
						})
					]
				}),
				"\n",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-mcp.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-mcp.mdx";
