	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "VALUE-BEARING STREAM — the server pushes the whole value on every change" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  server                                   consumer (Code tab)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  git change ──► frame: { 5 changed files } ───► render" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  git change ──► frame: { 6 changed files } ───► render" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  every frame carries the FULL status      consumer just shows the latest frame" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// koluSurface (kolu's own, in-process) — schematic"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " app.streams.gitStatus."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "use"
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//    ^ a reactive accessor: each emission is the full GitStatusOutput, render it."
					})
				})
			] })
		}),
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "PROCEDURE + PULSE-THEN-REQUERY — the server pings; the consumer pulls" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "    │   ◄────────── getStatus() ───────────── (1) ask once" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "    │   ──────────► { 5 changed files } ─────► render" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  git change ─► pulse { seq: 1 } ─────────────► (2) \"something changed\"" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "    │   ◄────────── getStatus() ─────────────       re-query" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "    │   ──────────► { 6 changed files } ─────► render" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  git change ─► pulse { seq: 2 } ─────────────► re-query ──► render" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  the pulse carries NO data ({seq} only)   consumer pulls the full status" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "                                           only when it actually changed" })
				})
			] })
		}),
		"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// terminalWorkspaceSurface (the shared surface pulam serves) — schematic"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// 1. snapshot (a procedure call)"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "//    …re-query the procedure."
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "pollOnEvent  ── builds a value-bearing stream from a procedure + a pulse" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   read:    () => git.getStatus(repo)        ← pull the value   (the procedure)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   install: (cb) => subscribeRepoChange(cb)  ← when to re-pull   (the pulse)" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   isEqual: gitStatusOutputEqual             ← drop a frame if nothing changed" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
				...
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   │  a value-bearing stream                       │" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "   │  (re-reads on each pulse, emits only on change)│" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-live-data.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-live-data.mdx";
