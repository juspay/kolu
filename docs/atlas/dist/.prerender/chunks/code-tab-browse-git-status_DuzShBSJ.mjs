...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>  Local / Branch ─────────▶ status.files ───┐</span></span>\n<span class=\"line\"><span>  All files ──┬─ local ───▶ overlay(local,  ├─▶ treeGitStatus ─▶ &#x3C;FileTree> ─▶ Pierre</span></span>\n<span class=\"line\"><span>              └─ branch ──▶   branch) ← new ─┘                    data-item-git-status</span></span>\n<span class=\"line\"><span>                 local wins on conflict</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/code-tab-browse-git-status.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/code-tab-browse-git-status.mdx";
