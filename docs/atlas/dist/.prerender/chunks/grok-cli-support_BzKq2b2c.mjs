...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>~/.grok/</span></span>\n<span class=\"line\"><span>  active_sessions.json          # [{ session_id, pid, cwd, opened_at }, …]</span></span>\n<span class=\"line\"><span>  sessions/&#x3C;urlencode(cwd)>/</span></span>\n<span class=\"line\"><span>    &#x3C;uuid>/</span></span>\n<span class=\"line\"><span>      events.jsonl              # phase_changed · tool_* · turn_started/ended</span></span>\n<span class=\"line\"><span>      summary.json              # model, title, created_at, cwd</span></span>\n<span class=\"line\"><span>      chat_history.jsonl        # full transcript (export later)</span></span>\n<span class=\"line\"><span>      updates.jsonl             # ACP-style session/update stream</span></span>\n<span class=\"line\"><span>      …</span></span></code></pre>" }),
		"\n",
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// STABLE_FLAGS</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">[</span><span style=\"color:#032F62\">\"grok\"</span><span style=\"color:#24292E\">, </span><span style=\"color:#D73A49\">new</span><span style=\"color:#6F42C1\"> Set</span><span style=\"color:#24292E\">([</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--model\"</span><span style=\"color:#24292E\">, </span><span style=\"color:#032F62\">\"-m\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--always-approve\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--permission-mode\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--agent\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--no-plan\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--no-subagents\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#032F62\">  \"--reasoning-effort\"</span><span style=\"color:#24292E\">, </span><span style=\"color:#032F62\">\"--effort\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">])],</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// BASENAME_TO_KIND / AgentKindSchema</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">grok</span><span style=\"color:#24292E\">: </span><span style=\"color:#032F62\">\"grok\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#6A737D\">// AGENT_RESUME</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">grok</span><span style=\"color:#24292E\">: {</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  last</span><span style=\"color:#24292E\">: </span><span style=\"color:#032F62\">\"-c\"</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  byId</span><span style=\"color:#24292E\">: (</span><span style=\"color:#E36209\">id</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#032F62\"> `--resume ${</span><span style=\"color:#24292E\">id</span><span style=\"color:#032F62\">}`</span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  idPattern</span><span style=\"color:#24292E\">: </span><span style=\"color:#005CC5\">UUID_RE</span><span style=\"color:#24292E\">, </span><span style=\"color:#6A737D\">// same shell-safe UUID gate as claude/codex</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">},</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"plaintext\"><code><span class=\"line\"><span>packages/integrations/grok/</span></span>\n<span class=\"line\"><span>  package.json                 # name: kolu-grok, exports . + ./schemas</span></span>\n<span class=\"line\"><span>  src/</span></span>\n<span class=\"line\"><span>    config.ts                  # KOLU_GROK_DIR override, GROK_DIR, paths</span></span>\n<span class=\"line\"><span>    schemas.ts                 # GrokInfoSchema (browser-safe)</span></span>\n<span class=\"line\"><span>    core.ts                    # encodeCwd, readActiveSessions, findSession, foldState</span></span>\n<span class=\"line\"><span>    session-watcher.ts         # fs.watch events.jsonl + summary.json</span></span>\n<span class=\"line\"><span>    agent-adapter.ts           # grokAdapter</span></span>\n<span class=\"line\"><span>    index.ts                   # barrel</span></span>\n<span class=\"line\"><span>    *.test.ts</span></span></code></pre>" }),
		"\n",
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/grok-cli-support.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/grok-cli-support.mdx";
