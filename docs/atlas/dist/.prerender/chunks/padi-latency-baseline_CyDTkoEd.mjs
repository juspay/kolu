	...
	return createVNode(Fragment, { children: [
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: createVNode(_components.span, {
				class: "line",
				children: createVNode(_components.span, { children: "just bench-typing-echo" })
			}) })
		}),
		"\n",
		createVNode(_components.p, { children: [
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/padi-latency-baseline.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/padi-latency-baseline.mdx";
