...
function _createMdxContent(props) {
	...
	return createVNode(Fragment, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">|</span><span style=\"color:#24292E\"> { </span><span style=\"color:#6F42C1\">kind</span><span style=\"color:#24292E\">: </span><span style=\"color:#032F62\">\"warming\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#6F42C1\">membershipId</span><span style=\"color:#24292E\">: string }                          </span><span style=\"color:#6A737D\">// in motion — coming up, or coming back on its own</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">|</span><span style=\"color:#24292E\"> { </span><span style=\"color:#6F42C1\">kind</span><span style=\"color:#24292E\">: </span><span style=\"color:#032F62\">\"connected\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#6F42C1\">membershipId</span><span style=\"color:#24292E\">: string; </span><span style=\"color:#6F42C1\">clockOffset</span><span style=\"color:#24292E\">: number </span><span style=\"color:#D73A49\">|</span><span style=\"color:#005CC5\"> null</span><span style=\"color:#24292E\"> } </span><span style=\"color:#6A737D\">// live (link-liveness); offset null = not-yet-measured</span></span>\n<span class=\"line\"><span style=\"color:#D73A49\">|</span><span style=\"color:#24292E\"> { </span><span style=\"color:#6F42C1\">kind</span><span style=\"color:#24292E\">: </span><span style=\"color:#032F62\">\"failed\"</span><span style=\"color:#24292E\">; </span><span style=\"color:#6F42C1\">membershipId</span><span style=\"color:#24292E\">: string; </span><span style=\"color:#6F42C1\">failure</span><span style=\"color:#24292E\">: Failure }         </span><span style=\"color:#6A737D\">// NOT proceeding without intervention</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
			"Every arm carries a ",
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#6A737D\">// Layer 2: membership drives the key set (via keyArray); \"active\" stays app policy.</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">scopedByEntry</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#6F42C1\">K</span><span style=\"color:#24292E\">, </span><span style=\"color:#6F42C1\">T</span><span style=\"color:#24292E\">>(map: SurfaceMapClient</span><span style=\"color:#D73A49\">&#x3C;</span><span style=\"color:#24292E\">…</span><span style=\"color:#D73A49\">></span><span style=\"color:#24292E\">, active: Accessor</span><span style=\"color:#D73A49\">&#x3C;</span><span style=\"color:#005CC5\">K</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#005CC5\"> null</span><span style=\"color:#D73A49\">></span><span style=\"color:#24292E\">,</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">                    build: (</span><span style=\"color:#E36209\">key</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> K</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">ctx</span><span style=\"color:#D73A49\">:</span><span style=\"color:#24292E\"> { </span><span style=\"color:#E36209\">isActive</span><span style=\"color:#D73A49\">:</span><span style=\"color:#6F42C1\"> Accessor</span><span style=\"color:#24292E\">&#x3C;</span><span style=\"color:#005CC5\">boolean</span><span style=\"color:#24292E\">> }) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#005CC5\"> T</span><span style=\"color:#24292E\">): {</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  active: Accessor</span><span style=\"color:#D73A49\">&#x3C;</span><span style=\"color:#005CC5\">T</span><span style=\"color:#D73A49\">></span><span style=\"color:#24292E\">;              </span><span style=\"color:#6A737D\">// the active key's world — re-keys on switch</span></span>\n<span class=\"line\"><span style=\"color:#6F42C1\">  get</span><span style=\"color:#24292E\">(key: </span><span style=\"color:#005CC5\">K</span><span style=\"color:#24292E\">): </span><span style=\"color:#005CC5\">T</span><span style=\"color:#D73A49\"> |</span><span style=\"color:#005CC5\"> undefined</span><span style=\"color:#24292E\">;       </span><span style=\"color:#6A737D\">// background peek (attention rollups, W5)</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">}</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
		...
		"\n",
		createVNode(Fragment$1, { "set:html": "<pre class=\"astro-code github-light\" style=\"background-color:#fff;color:#24292e; overflow-x: auto;\" tabindex=\"0\" data-language=\"ts\"><code><span class=\"line\"><span style=\"color:#D73A49\">export</span><span style=\"color:#D73A49\"> const</span><span style=\"color:#005CC5\"> hostScopes</span><span style=\"color:#D73A49\"> =</span><span style=\"color:#6F42C1\"> scopedByEntry</span><span style=\"color:#24292E\">(padiMap, activeHost, (</span><span style=\"color:#E36209\">host</span><span style=\"color:#24292E\">, </span><span style=\"color:#E36209\">ctx</span><span style=\"color:#24292E\">) </span><span style=\"color:#D73A49\">=></span><span style=\"color:#24292E\"> ({</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  view: </span><span style=\"color:#6F42C1\">createViewState</span><span style=\"color:#24292E\">(),          </span><span style=\"color:#6A737D\">// activeId / mru / attention — plain signals now</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  camera: </span><span style=\"color:#6F42C1\">createCamera</span><span style=\"color:#24292E\">(ctx),        </span><span style=\"color:#6A737D\">// born per-host; centers on ctx.isActive</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  tiles: </span><span style=\"color:#6F42C1\">createTileStore</span><span style=\"color:#24292E\">(host),</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">  restore: </span><span style=\"color:#6F42C1\">createSessionRestore</span><span style=\"color:#24292E\">(host),</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">}));</span></span>\n<span class=\"line\"><span style=\"color:#24292E\">hostScopes.</span><span style=\"color:#6F42C1\">active</span><span style=\"color:#24292E\">().view.activeId; </span><span style=\"color:#6A737D\">// always the ACTIVE host's — by construction</span></span></code></pre>" }),
		"\n",
		createVNode(_components.p, { children: [
			"The ",
...
var file = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/surface-map-101.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/RT-fable/docs/atlas/src/content/atlas/surface-map-101.mdx";
