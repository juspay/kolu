			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 0 · THE PACKAGE UNDER PROPOSAL — every map API below comes from it"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: " \"@kolu/surface-map/server\""
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ";    "
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: " \"@kolu/surface-map/client\""
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ";  "
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// client half (+ /solid: useEntry)"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 1 · CONTRACT — no new spec invented: the map is built over kolu's REAL padi surface"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     (packages/padi/src/surface.ts — its `urgency` cell {awaiting, awaitingIds} and"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//      `terminals` collection already exist and already stream today)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(HostKeySchema, padiSurface);"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ↑ HostKeySchema BRANDS the key; brings `entries: Collection<HostKey, EntryStatus>` free —"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//   the ONE membership authority (warming | connected | failed(reason), + clockOffset;"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//   absence = not in the collection)"
					})
				}),
				"\n",
				createVNode(_components.span, { class: "line" }),
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 2 · SERVER (kolu-server) — the warm ssh pool IS the resolver; env seeds membership."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     buildRemotePool is NOT map API — it's the EXISTING pool from @kolu/surface-remote"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     (né surface-nix-host's buildHostRegistry, renamed with the package: one warm"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     DaemonSession per host — ssh dial, nix provisioning, reconnect). Pool ≠ map: the"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     pool owns the UPSTREAM connections (its volatility: ssh/nix/daemon lifetime); the"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     map owns the DOWNSTREAM serving shape (membership on the wire)."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     The pool is the single WRITER of membership; the map's `entries` collection is"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     that truth PUBLISHED — one writer, one projection (P3). The resolver seam is the"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     boundary: any session source can back a map (this pool, drishti's agent shipper,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     the e2e harness's mock subprocesses)."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// né buildHostRegistry / surface-nix-host"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// MapRegistry = { members(), subscribe(onChange), has(key), resolve(key) => EntrySession | EntryFault }"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// — membership as a first-class SUBSCRIBABLE fact (it must DRIVE the entries collection; a fused"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// resolve-only seam can't observe changes). onChange fires only AFTER members()/has() reflect the"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// change; status is DERIVED from the resolved session's state (projection, not a second writer)."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// hosts.add/remove stay root RPCs writing the pool — one writer, runtime-ephemeral"
					})
				}),
				"\n",
				createVNode(_components.span, { class: "line" }),
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 3 · CLIENT — construct the typed map client ONCE from the contract + the app's link"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     (this is where `app.padiHosts` comes from — nothing ambient)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//     the switcher chips: every host's agent urgency, LIVE, one loop"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "{app.padiHosts.entries.use().keys()}"
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: ">"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "{app.padiHosts.entry(host).state()}            "
						}),
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// EntryStatus | not-a-member — a VALUE"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "{app.padiHosts.entry(host).cells.urgency.use().value()?.awaiting}"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// 4 · CLIENT — the canvas follows the picked host; switching = writing a signal"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// per-tab, sessionStorage-backed"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// Solid-only: owns swap disposal"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "active.cells.terminals."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "use"
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// re-keys on switch, synchronous first value; a removed host's"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "                               // subs end typed {reason:\"removed\"} — the fallback policy reads"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "                               // entry(host).state() and falls back to local: a value, no callback"
					})
				})
			] })
		}),
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/remote-surfaces.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/remote-surfaces.mdx";
