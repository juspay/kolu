			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// App.tsx:604-614  (and CodeTab.tsx:482-483, vertical split)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// useRightPanel.ts:118-128"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "updatePreferences"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ rightPanel: { size } }); },"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ rightPanel: { codeTabTreeSize: size } }); },"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// wire.ts:72-78 → useCell.ts:189-192 (local authority)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// sync store write + server RPC, every call"
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ChromeBar.tsx:112-114"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: " const EPSILON = 1e-6; // Corvu fixToPrecision rounds to PRECISION=6"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "     updatePreferences({ rightPanel: { size } });"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: " // same Math.abs(size - rp().codeTabTreeSize) > EPSILON guard on setCodeTabTreeSize"
					})
				})
			] })
		}),
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: " // useCellLocal: apply locally every call (sync — ChromeBar tracks live),"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: " // trailing-debounce only the server mutate."
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "   applyLocal(p);                         // sync store write, unchanged"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "   if (coalesce) coalesce.push(p);        // trailing debounce → mutate(merged)"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "   else await options.mutate(p);"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: " // wire.ts — opt in for preferences only:"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: " app.cells.preferences.use({ authority: \"local\", initial: DEFAULT_PREFERENCES,"
					})
				}),
				"\n",
				createVNode(_components.span, {
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/pref-storm.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/pref-storm.mdx";
