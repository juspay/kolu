			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// final top-level router"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// rejects on an owned runtime fault"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// idempotent; releases every owned source"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // package-private mount material for composition"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  entry: padiEntrySurface,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "  failure: PadiEntryFailureSchema,"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [createVNode(_components.span, {
						style: { color: "#6F42C1" },
						children: "serveHostMap"
					}), createVNode(_components.span, {
						style: { color: "#24292E" },
						children: "(padiHostMap, pool, {"
					})]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // A verdict, not a fabrication: a schema-valid failure, or `null` = \"this down"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // state is not a standing failure — keep the entry warming\" (a live host's normal"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // reconnect window). A terminal give-up that yields `null` is a classification"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // defect and fails loud (`UnclassifiedHostFailureError`), never a bucketed catch-all."
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " classifyPadiFailure"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(host, session, downState);"
						})
					]
				}),
				"\n",
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// any future padi feature, any file:"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " requireMutableTerminal"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(id);"
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ^ the registry's accessor for mutation handlers (terminal-registry.ts:277):"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//   looks the id up and returns the LIVE TerminalProcess object itself —"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "//   whoever holds it can assign to entry.meta/entry.snapshot directly."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "entry.meta.lastActivityAt "
						}),
						createVNode(_components.span, {
							style: { color: "#D73A49" },
							children: "="
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// mutates the registry in place"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ...forgot: publishComposedTerminal(id)  ← the convention. Nothing enforces it."
					})
				})
			] })
		}),
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// there is no bare entry to mutate; this is the ONLY write:"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "t.meta, lastActivityAt: now } }));"
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// SR7 — a DERIVED fact can't be forgotten: the graph tracks the edge, no"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// writer calls anything (servePadi.ts:251):"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// SR8 — the fold stays O(M) on the firehose: $.terminals() reads a per-key"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// materialized cache instead of re-composing all M (servePadi.ts:314):"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " materializeSiblingView"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: ": "
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// gate-proven: urgencyComposeCost.test.ts — 24 composes/cycle at M=24, vs 600."
					})
				}),
				"\n",
				createVNode(_components.span, { class: "line" }),
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// SR8 + SR9 — the keyed machinery exists:"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ read, install })),   "
						}),
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// wire reconciler"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: " reactiveFamily"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "({ members, attach, onEvict }); "
						}),
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// serveHostMap (SR9)"
						})
					]
				})
			] })
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// the store to replace IS the source of truth (terminal-registry.ts:95):"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// in-place mutation on the ~150 ms firehose, once per live terminal"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// (metadata.ts:154) — every such site must route through the new store's"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// write so the change edge fires:"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ~17 synchronous readers that must keep working WITHOUT reactivity —"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// they need a pull face (keys/has/get), not signals:"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "requireActiveTerminal"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(); "
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// park/restore/sleep/wake walk the raw map (terminal-registry.ts:149-173) —"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// the restore's parked→active flip is the restore-idempotency token and must"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// survive a store whose writes now also emit wire frames:"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// terminal-registry.ts — the registry IS the reactive store now:"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// the 17 synchronous readers survive on the pull face, unchanged signatures:"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// requireMutableTerminal is DELETED — the raw-entry door the defect walks"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// through cannot exist: nothing hands out a live object to mutate silently."
					})
				}),
				"\n",
				createVNode(_components.span, { class: "line" }),
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// metadata.ts — the five seams SURVIVE as the domain vocabulary; only the"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// ritual line dies. Cold paths use the immutable update:"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "  // no publishComposedTerminal(id) — the write IS the wire frame"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// the ~150 ms firehose CANNOT afford a spread per poke (the alloc cost SR7/SR8"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// fought), so the hot seam uses the in-place poke form — mutate, then the store"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// bumps that key's version (the reactiveFamily precedent: in-place `latest` +"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// a version-signal change edge):"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// servePadi.ts — the collection is declared FROM the store; the wire member"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// stops being convention-published:"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// downstream derivations unchanged:"
					})
				}),
				"\n",
				createVNode(_components.span, {
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// wire.ts:277 — preferences"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " app.cells.preferences."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "use"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// the #1041 drag-frame debounce"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// HostDaemonChips.tsx:146 — processMemory, per host"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(host).cells.processMemory."
						}),
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "use"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: "`Padi/kaval memory error: ${"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "err"
		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// common — policy is DATA: a closed discriminated union, never a string."
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// (A toast FUNCTION can't live in common; the declaration carries the typed"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// intent, the client owns the one interpreter of each arm.)"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// label is payload, kind is checked"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// observable but silent to the user"
						})
					]
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6A737D" },
							children: "// routes to the host-membership handler"
						})
					]
				}),
				"\n",
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// client — ONE interpreter per arm, registered once (satisfies-never fenced,"
					})
				}),
				"\n",
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// so a new policy kind FORCES a decision here):"
					})
				}),
				"\n",
				createVNode(_components.span, {
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#6F42C1" },
							children: "onHostMembershipError"
						}),
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "(err); "
				...
				createVNode(_components.span, {
					...
					children: createVNode(_components.span, {
						style: { color: "#6A737D" },
						children: "// the use-site shrinks to the read; policy is unrepeatable:"
					})
				}),
				"\n",
				createVNode(_components.span, {
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-runtime-boundary.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/surface-runtime-boundary.mdx";
