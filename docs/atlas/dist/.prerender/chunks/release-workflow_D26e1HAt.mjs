		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "website/src/content/changelog/" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  unreleased.mdx     ← agent appends here, every user-facing PR" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "  1-0-0.mdx          ← stamped { version: \"1.0.0\", date: 2026-06-08 } at release" })
				})
			] })
		}),
		"\n",
			...
			children: createVNode(_components.code, { children: [
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " Compose surfaces as siblings — one canvas, no surface-app seams. ("
						}),
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: "[#"
						...
						createVNode(_components.span, {
							...
							children: "https://github.com/juspay/kolu/pull/1201"
						}),
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: ")"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: " Dock pings stop pulsing once you switch to the row. ("
						}),
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: "[#"
						...
						createVNode(_components.span, {
							...
							children: "https://github.com/juspay/kolu/pull/1198"
						}),
						createVNode(_components.span, {
							style: { color: "#032F62" },
							children: ")"
				...
				createVNode(_components.span, {
					...
					children: [
						...
						createVNode(_components.span, {
							style: { color: "#24292E" },
							children: "; existing sessions auto-migrate."
						})
					]
				})
			] })
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/release-workflow.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/release-workflow.mdx";
