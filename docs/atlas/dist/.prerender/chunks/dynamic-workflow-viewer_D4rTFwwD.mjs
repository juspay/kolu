		...
		createVNode(_components.pre, {
			...
			children: createVNode(_components.code, { children: [
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "~/.claude/projects/<encoded-cwd>/<session>.jsonl              # main transcript — launch markers + completion notifications" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "~/.claude/projects/<encoded-cwd>/<session>/" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "├── workflows/scripts/<name>-<runId>.js                       # persisted script — meta.name + meta.phases[]" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "└── subagents/workflows/" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "    ├── wf_84c9119d-127/  journal.jsonl + agent-*.jsonl       # run 1" })
				}),
				"\n",
				createVNode(_components.span, {
					class: "line",
					children: createVNode(_components.span, { children: "    └── wf_e6f94ccf-a1f/  journal.jsonl + agent-*.jsonl       # run 2 …" })
				})
			] })
		}),
		"\n",
...
var file = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/dynamic-workflow-viewer.mdx";
...
Content.moduleId = "/home/srid/code/kolu/.worktrees/chat-1/docs/atlas/src/content/atlas/dynamic-workflow-viewer.mdx";
