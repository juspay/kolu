...
| Review | **the gauntlet — retired 2026-09-17.** lens-debate, /agent-debate (an explicitly selected Claude, Codex, or Grok peer adversarially reviewing, warm-session, to consensus) and code-police were deleted with the `srid/agency` dependency; a review today is the repo's own rules (`code-review.instructions.md`) plus the two structural lenses |
