...
| Review | **the gauntlet — retired.** lens-debate, /agent-debate (an explicitly selected Claude, Codex, or Grok peer adversarially reviewing, warm-session, to consensus) and code-police were deleted with the `srid/agency` dependency (<PrLink pr={2254} />); a review today is the repo's own rules plus the two structural lenses |
