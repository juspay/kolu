...
Four PRs, each independently shippable, ordered by harm:
...
**PR 3 — the face verb** — *waits on kolu-tui* (rides the kolu-tui build-out, not before).
...
is **demand-gated into this PR only if** command-rooted terminals become
