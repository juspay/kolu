...
| PRT5 ✅ | the host, not just the subtree — detached servers found, claimed by the printing tile, never reaped | PRT4 | e2e: a detached listener's printed URL → card "elsewhere" · detached row in Ports · door survives two reap intervals |
...
### PRT5 — the host, not just the subtree
