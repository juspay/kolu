...
- **The campaigns** (few substantial refactors — the plan lives in the ledger note): ① complete the primitives — W5 phase-1, absorbing L28 rung 2 · L1 · L20·21 under its one drishti pairing; ② the padi/server re-cut — L27 (opening pure-motion commit) · L17 · L24, with L13 riding; ③ the client wire/state sweep — L11 · L18. L8 (the doc sweep) rides every campaign — hygiene never ships standalone.
