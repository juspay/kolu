...
export const ROADMAP = [
  ...
  { d: 0, g: "○", c: "prog", l: "W10 · hosts survive a restart — pool membership persisted beside its one writer", m: "ratified 2026-07-11 · after W9", h: "#w10" },
...
<Phase id="W10" name="hosts survive a restart — pool membership persisted beside its one writer" status="todo" needs={["W6"]} />
<Phase id="future" name="future work — cross-host dock (B-lite) · kolu-tui · hybrid canvas only if earned" status="todo" needs={["W4"]} />

**As of 2026-07-11, in order:**
...
2. **W10 — hosts survive a restart** follows (ratified 2026-07-11): server-side, no code dependency on W9 — it takes the next number because W9 is already in flight.
...
### W10 — hosts survive a restart *(ratified 2026-07-11 — after W9)*
