...
- **Gated:** L11 on W3.2 · L2 on kolu-tui (W5) · L9, L22 on evidence · L23, L24 on W3.1 (#1675) merging
...
*Status: gated on W3.1 (#1675) merging · Lens: parity (kaval-tui `--host` is the shipped precedent) · Gate: none (kolu-internal)*
