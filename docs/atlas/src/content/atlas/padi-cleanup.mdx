...
- **Ready now:** L1 · L8 · L10 · L11 (unblocked — W4 shipped <PrLink pr={1714} />) · L12 (srid mints) · L13 · L17 (+ video-ext table, was L5b) · L18 · L24 · L27 · L20·21 — and L28 rung 2 once W6 merges; L4 at a named version
- **In review (implemented, draft PR):** L26 — sweep found the class already retired; the `no-overloaded-null` guardrail is the deliverable
