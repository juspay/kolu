...
<Svg svg={birdseye} caption="The W4 ledger at a glance. Top lane: the switch-prep critical path (L3 shipped → L6 in flight → L23 queued → the W3.2 switch → L11's post-switch sweep). Amber-dashed = gated; pills are milestones that live outside this ledger." />

**Status index** — updated as entries ripen or ship:

- **Ready now:** L1 · L6 · L7 · L8 · L10 · L12 (srid mints) · L13 · L14 · L15 · L16 · L17 · L18 · L19 · L20 (drishti) · L21 (drishti) · L23 · L24 (W3.1 merged 2026-07-04) — and L4 at a named version; L5's remaining half (video-ext table)
- **Gated:** L11 on W3.2 · L2 on kolu-tui (W5) · L9, L22 on evidence
...
*Status: READY (W3.1 merged 2026-07-04) · Lens: lowy (same policy, second hand-rolled site) · Gate: none (kolu-internal)*
