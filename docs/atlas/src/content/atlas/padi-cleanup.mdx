...
*Status: READY (re-verified 2026-07-09: the `packages/pulam*` packages are fully DELETED from master, yet **33 non-test src files** still reference them in comments/prose — the sweep is riper than when filed) · Lens: hygiene · Gate: none*
