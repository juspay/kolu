...
(per <Cite file=".claude/rules/workflow.md" />).
...
| Manifest call-site | <Cite file="packages/server/src/index.ts" lines="223" /> | Pass `description` + maskable icon into `installPwaManifest` |
