...
kolu: "kolu — SolidJS web ADE (R-4: pty-host is the survivor)" {
  ...
  tui: "kolu-tui (raw client) — shipped: list / snapshot / attach (spawn/kill = Phase 3, planned)"
...
3. **kolu-tui:** A5's socket path and G3's attach TTY-guard shipped (<PrLink pr={1084} />, <PrLink pr={1255} />); carry the non-tty contract forward to Phase 3's `kill`/`spawn`.
