...
| 4 | **Codify design philosophy as an always-loaded rule** (fail-fast/no-fallbacks · electricity boundaries · reuse-existing-source) and force §2 to read it | `.apm/instructions/conventions.instructions.md` → `conventions.md`; `be` §2 | S · **high** |
...
<Roadmap>
  <Milestone status="next" label="Round 1 — quick wins">#1 Stop-guard wire-in · #3 every-PR CI + master-sync · #4 design-philosophy rule · #6 CI-triage policy. Then re-run this audit and compare mean autonomy.</Milestone>
