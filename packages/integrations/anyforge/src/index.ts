 ...
 *
 *  Leaf package (deps: @kolu/log types + effect + ts-pattern) owning the
 ...
 *  `ForgeAdapter` against these shapes and never import each other; `anyagent`
...
export type { PrGitContext, ForgeAdapter } from "./adapter.ts";
...
// schema or helper is added. (./adapter, ./subscribe stay explicit:
