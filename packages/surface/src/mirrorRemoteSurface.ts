 ...
 *  effect@4.0.0-rc.112: a `forkChild`ed effect that fails leaves the parent
 ...
 *
 *  BETA-ASSUMPTION(rc.112): a failed `Effect.forkChild` child does NOT fail its parent fiber.
