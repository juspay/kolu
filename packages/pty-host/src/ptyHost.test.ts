...
// The headless screen-mirror + getScreenText helper now live in
// `@kolu/solid-xterm/headless` and are unit-tested there
// (`packages/solid-xterm/src/headless.test.ts`). This file covers the host's
// behaviour over real node-pty children.
