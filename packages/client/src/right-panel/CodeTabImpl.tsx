/** CodeTabImpl — code review and browsing for the terminal's current repo.
 *
 * The heavy main-thread chunk (Pierre `FileTree`, `@kolu/solid-markdown`,
 * the diff/source view wrappers, the comment system). `./CodeTab` is the
 * thin `lazy()` + `Suspense` wrapper that owns this chunk's loading strategy;
 * this module is the implementation it pulls.
 *
