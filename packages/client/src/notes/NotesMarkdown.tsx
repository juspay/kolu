 ...
 *  for the two notes use-sites, so the call sites (title bar, dock
 *  rows, switcher cards, sub-panel tabs, notes body + Notes tab editor) stay
 ...
 *  slot's click handler (open Notes tab / open palette) isn't preempted by a
 *  nested anchor — which is the package's default for the inline variant,
 *  so `links` is passed through unset rather than re-defaulted here. */
