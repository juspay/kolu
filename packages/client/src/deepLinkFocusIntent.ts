 ...
 *  target to its owning tile. Never cleared: it holds the latest target and only
 *  the one-shot boot hydration reads it; the membership guard makes persistence
 *  benign. */
