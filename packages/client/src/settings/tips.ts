...
export const AMBIENT_TIPS: readonly Tip[] = [
  ...
  },
  {
    ...
    text: `${formatKeybind(ACTIONS.commandPalette.keybind)} → "Export agent session as HTML" saves the active Claude/Codex/OpenCode/Grok/Pi/Oh My Pi transcript as a chat log, a full transcript, or both`,
    doc: "power-features",
  },
  {
    id: "amb-inspector",
