...
nix_format_paths := '*.nix nix/**/*.nix website/*.nix ci/flake.nix packages/surface/example/flake.nix packages/solid-browser/example/flake.nix packages/padi/native/default.nix'
